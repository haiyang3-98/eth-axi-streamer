...
## IP Info
set Vendor      "ethz.systems"
set Library     "hls"
set IPName      "toe"
set Version     "1.6"
set DisplayName "10G TCP Offload Engine"
set Revision    "2112599236"
set Description "TCP Offload Engine supporting 10Gbps line rate, up to 10K concurrent sessions."
set Device      "virtexuplus"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xcvu3p-ffvc1517-2-i"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "toe_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/toe/toe_prj/solution1"
set debug_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/toe/toe_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {toe_top_regslice_both
...
toe_top_listening_port_table_listeningPortTable
toe_top_free_port_table_freePortTable
...
toe_top_regslice_both
toe_top_regslice_both
toe_top_tx_app_table_app_table_ackd_V
toe_top_fifo_w16_d2_S
toe_top_fifo_w16_d2_S
toe_top_fifo_w32_d2_S
toe_top_fifo_w16_d15_S
toe_top_fifo_w16_d15_S
toe_top_fifo_w32_d4_S
toe_top_fifo_w32_d16_S
...
toe_top_fifo_w96_d2_S
toe_top_fifo_w96_d2_S
toe_top_fifo_w192_d2_S
toe_top_fifo_w192_d2_S
toe_top_fifo_w128_d16_A
toe_top_fifo_w128_d16_A
toe_top_fifo_w192_d16_A
toe_top_fifo_w64_d16_S
toe_top_fifo_w192_d16_A
...
toe_top_fifo_w1_d4_S
toe_top_fifo_w1_d4_S
toe_top_fifo_w128_d2_S
toe_top_fifo_w128_d64_A
toe_top_fifo_w128_d2_S
toe_top_fifo_w32_d2_S
toe_top_fifo_w64_d2_S
toe_top_fifo_w16_d2_S
toe_top_fifo_w96_d4_S
toe_top_fifo_w96_d4_S
toe_top_fifo_w16_d2_S
...
toe_top_fifo_w16_d2_S
toe_top_fifo_w16_d2_S
toe_top_fifo_w224_d512_A
toe_top_fifo_w224_d64_A
toe_top_fifo_w128_d64_A
...
toe_top_fifo_w1024_d8_A
toe_top_fifo_w1024_d32_A
toe_top_fifo_w4_d2_S
toe_top_fifo_w320_d2_S
toe_top_fifo_w4_d2_S
toe_top_fifo_w160_d2_S
toe_top_fifo_w224_d2_S
toe_top_fifo_w1_d2_S
toe_top_fifo_w288_d2_S
toe_top_fifo_w96_d4_S
toe_top_fifo_w1_d2_S
toe_top_fifo_w128_d2_S
toe_top_fifo_w96_d4_S
toe_top_fifo_w16_d32_S
toe_top_fifo_w160_d32_A
toe_top_fifo_w1_d4_S
toe_top_fifo_w1_d32_S
toe_top_fifo_w128_d32_A
toe_top_fifo_w96_d2_S
toe_top_fifo_w1_d32_S
...
toe_top_fifo_w128_d64_A
toe_top_fifo_w128_d64_A
toe_top_fifo_w96_d64_A
toe_top_fifo_w128_d64_A
toe_top_fifo_w128_d128_A
toe_top_fifo_w1024_d1024_A
toe_top_entry3
toe_top_entry22
...
set Interfaces {
    ...
    s_axis_txwrite_sts_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_txwrite_sts_V"
        has_tready "1"
        ports {
            TDATA 40
        }
    ...
    s_axis_rxread_data {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rxread_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    s_axis_txread_data {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_txread_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    m_axis_txwrite_cmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_txwrite_cmd_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    m_axis_txread_cmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_txread_cmd_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    m_axis_rxwrite_data {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rxwrite_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    m_axis_txwrite_data {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_txwrite_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    s_axis_session_lup_rsp_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_session_lup_rsp_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    s_axis_session_upd_rsp_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_session_upd_rsp_V"
        has_tready "1"
        ports {
            TDATA 160
        }
    ...
    m_axis_session_lup_req_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_session_lup_req_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_session_upd_req_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_session_upd_req_V"
        has_tready "1"
        ports {
            TDATA 160
        }
    ...
    s_axis_listen_port_req_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_listen_port_req_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_rx_data_req_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_data_req_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_open_conn_req_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_open_conn_req_V"
        has_tready "1"
        ports {
            TDATA 64
        }
    ...
    s_axis_close_conn_req_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_close_conn_req_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_tx_data_req_metadata_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tx_data_req_metadata_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_tx_data_req {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tx_data_req"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    m_axis_listen_port_rsp_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_listen_port_rsp_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    m_axis_notification_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_notification_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_rx_data_rsp_metadata_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rx_data_rsp_metadata_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_rx_data_rsp {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rx_data_rsp"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    m_axis_open_conn_rsp_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_conn_rsp_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_tx_data_rsp_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_data_rsp_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    ap_clk {
        ...
        buses "s_axis_tcp_data s_axis_txwrite_sts_V s_axis_rxread_data s_axis_txread_data m_axis_tcp_data m_axis_txwrite_cmd_V m_axis_txread_cmd_V m_axis_rxwrite_data m_axis_txwrite_data s_axis_session_lup_rsp_V s_axis_session_upd_rsp_V m_axis_session_lup_req_V m_axis_session_upd_req_V s_axis_listen_port_req_V s_axis_rx_data_req_V s_axis_open_conn_req_V s_axis_close_conn_req_V s_axis_tx_data_req_metadata_V s_axis_tx_data_req m_axis_listen_port_rsp_V m_axis_notification_V m_axis_rx_data_rsp_metadata_V m_axis_rx_data_rsp m_axis_open_conn_rsp_V m_axis_tx_data_rsp_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 40 II x}
