...
attribute shreg_extract : string;
    ...
    signal trunc_ln674_fu_208_p1 : STD_LOGIC_VECTOR (447 downto 0);
    signal trunc_ln674_reg_362 : STD_LOGIC_VECTOR (447 downto 0);
    signal p_Result_7_i_reg_368 : STD_LOGIC_VECTOR (55 downto 0);
    ...
    signal p_Result_8_i_fu_222_p4 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal select_ln1127_fu_308_p3 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_Result_7_i_reg_368 <= s_axis_tx_data_internal_dout(567 downto 512);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_load_load_fu_172_p1 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then
                reg_164 <= prevWord_data_V_1(511 downto 448);
                reg_168 <= prevWord_keep_V_1(63 downto 56);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op17_read_state1, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_351 = ap_const_lv1_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op45_write_state2 = ap_const_boolean_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op17_read_state1 = ap_const_boolean_1) and (s_axis_tx_data_internal_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op17_read_state1, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, s_axis_tx_data_internal_empty_n, ap_predicate_op17_read_state1, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((ls_writeRemainder_load_reg_351 = ap_const_lv1_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op45_write_state2 = ap_const_boolean_1) and (tx_shift2udpFifo_full_n = ap_const_logic_0)));
    end process;
    ...
    or_ln_fu_328_p5 <= (((ap_const_lv57_100000000000000 & reg_168) & ap_const_lv448_lc_1) & reg_164);
    p_Result_1_fu_279_p3 <= (p_Result_7_i_reg_368 & ap_const_lv8_FF);
    p_Result_2_fu_286_p3 <= (trunc_ln674_reg_362 & reg_164);
    p_Result_3_fu_293_p3 <= (p_Result_7_i_reg_368 & reg_168);
    p_Result_8_i_fu_222_p4 <= s_axis_tx_data_internal_dout(575 downto 568);
    p_Result_s_fu_272_p3 <= (trunc_ln674_reg_362 & ap_const_lv64_0);
    p_s_fu_316_p5 <= (((ap_const_lv447_lc_1 & sendWord_last_V_reg_374) & select_ln1127_fu_308_p3) & sendWord_data_V_2_fu_300_p3);
    ...
    sendWord_last_V_fu_232_p2 <= "1" when (p_Result_8_i_fu_222_p4 = ap_const_lv8_0) else "0";
    tmp_i_nbreadreq_fu_86_p3 <= (0=>(s_axis_tx_data_internal_empty_n), others=>'-');
    trunc_ln674_fu_208_p1 <= s_axis_tx_data_internal_dout(448 - 1 downto 0);

    tx_shift2udpFifo_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tx_shift2udpFifo_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2, ap_block_pp0_stage0)
    begin
    ...
    tx_shift2udpFifo_din_assign_proc : process(ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2, p_s_fu_316_p5, zext_ln174_fu_340_p1, ap_condition_162)
    begin
    ...
    tx_shift2udpFifo_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_load_reg_351, ap_predicate_op45_write_state2, ap_block_pp0_stage0_11001)
    begin
