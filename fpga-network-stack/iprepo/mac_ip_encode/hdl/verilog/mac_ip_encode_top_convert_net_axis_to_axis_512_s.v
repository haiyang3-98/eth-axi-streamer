...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_75_reg_111 <= dataOut_internal_dout[32'd576];
        tmp_i_keep_i_reg_106 <= {{dataOut_internal_dout[575:512]}};
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((regslice_both_output_V_data_V_U_apdone_blk == 1'b1) | ((tmp_i_reg_97_pp0_iter1_reg == 1'd1) & (m_axis_ip_TREADY_int_regslice == 1'b0)));
end
...
assign m_axis_ip_TVALID = regslice_both_output_V_data_V_U_vld_out;

assign tmp_i_nbreadreq_fu_44_p3 = dataOut_internal_empty_n;

assign trunc_ln83_fu_75_p1 = dataOut_internal_dout[511:0];
