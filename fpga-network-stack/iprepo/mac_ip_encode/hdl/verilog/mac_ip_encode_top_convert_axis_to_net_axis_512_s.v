...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_ip_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_ip_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_ip_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_ip_TVALID_int_regslice == 1'b0)));
end
...
assign dataIn_internal_din = tmp_32_i_fu_79_p4;

assign s_axis_ip_TREADY = regslice_both_input_V_data_V_U_ack_in;

assign tmp_32_i_fu_79_p4 = {{{ref_tmp_last_i_reg_105}, {ref_tmp_keep_i_reg_100}}, {ref_tmp_data_i_reg_95}};

assign tmp_nbreadreq_fu_34_p6 = s_axis_ip_TVALID_int_regslice;
