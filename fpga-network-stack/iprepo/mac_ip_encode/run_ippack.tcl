...
set Library     "hls"
set IPName      "mac_ip_encode"
set Version     "2.0"
set DisplayName "MAC IP Encoder"
set Revision    "2112599224"
...
set xo_kernel_name "mac_ip_encode_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/mac_ip_encode/mac_ip_encode_prj/solution1"
set debug_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/mac_ip_encode/mac_ip_encode_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {mac_ip_encode_top_regslice_both
...
mac_ip_encode_top_regslice_both
mac_ip_encode_top_regslice_both
mac_ip_encode_top_fifo_w48_d2_S
mac_ip_encode_top_fifo_w32_d2_S
mac_ip_encode_top_fifo_w32_d2_S
mac_ip_encode_top_fifo_w48_d7_S
mac_ip_encode_top_fifo_w32_d3_S
mac_ip_encode_top_fifo_w32_d3_S
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w1024_d32_A
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w16_d16_S
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w256_d2_S
mac_ip_encode_top_fifo_w1024_d2_S
mac_ip_encode_top_fifo_w1024_d2_S
...
## Variables
set Top "mac_ip_encode_top"
set TopNoPrefix "mac_ip_encode_top"
...
set Interfaces {
    ...
    s_axis_arp_lookup_reply_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_arp_lookup_reply_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    m_axis_arp_lookup_request_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_arp_lookup_request_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "s_axis_ip s_axis_arp_lookup_reply_V m_axis_ip m_axis_arp_lookup_request_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 20 II x}
