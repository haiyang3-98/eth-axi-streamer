...
output   s_axis_tx_meta_V_TREADY;
 ...
 reg    ap_rst_n_inv;
wire    ipv4_top_entry3_U0_ap_start;
wire    ipv4_top_entry3_U0_ap_done;
wire    ipv4_top_entry3_U0_ap_continue;
wire    ipv4_top_entry3_U0_ap_idle;
wire    ipv4_top_entry3_U0_ap_ready;
wire   [31:0] ipv4_top_entry3_U0_local_ipv4_address_out_din;
wire    ipv4_top_entry3_U0_local_ipv4_address_out_write;
wire   [7:0] ipv4_top_entry3_U0_protocol_out_din;
wire    ipv4_top_entry3_U0_protocol_out_write;
wire    ipv4_top_entry6_U0_ap_start;
wire    ipv4_top_entry6_U0_ap_done;
wire    ipv4_top_entry6_U0_ap_continue;
wire    ipv4_top_entry6_U0_ap_idle;
wire    ipv4_top_entry6_U0_ap_ready;
wire    ipv4_top_entry6_U0_local_ipv4_address_read;
wire    ipv4_top_entry6_U0_protocol_read;
wire   [31:0] ipv4_top_entry6_U0_local_ipv4_address_out_din;
wire    ipv4_top_entry6_U0_local_ipv4_address_out_write;
wire   [7:0] ipv4_top_entry6_U0_protocol_out_din;
wire    ipv4_top_entry6_U0_protocol_out_write;
wire    convert_axis_to_net_axis_512_4_U0_ap_start;
wire    convert_axis_to_net_axis_512_4_U0_ap_done;
wire    convert_axis_to_net_axis_512_4_U0_ap_continue;
wire    convert_axis_to_net_axis_512_4_U0_ap_idle;
wire    convert_axis_to_net_axis_512_4_U0_ap_ready;
wire   [1023:0] convert_axis_to_net_axis_512_4_U0_s_axis_rx_data_internal_din;
wire    convert_axis_to_net_axis_512_4_U0_s_axis_rx_data_internal_write;
wire    convert_axis_to_net_axis_512_4_U0_s_axis_rx_data_TREADY;
...
wire   [1023:0] convert_axis_to_net_axis_512_U0_s_axis_tx_data_internal_din;
wire    convert_axis_to_net_axis_512_U0_s_axis_tx_data_internal_write;
wire    convert_axis_to_net_axis_512_U0_s_axis_tx_data_TREADY;
...
wire    convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_internal_read;
wire   [511:0] convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TDATA;
wire    convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TVALID;
wire   [63:0] convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TKEEP;
wire   [63:0] convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TSTRB;
wire   [0:0] convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TLAST;
...
wire   [63:0] process_ipv4_512_U0_m_axis_rx_meta_V_TDATA;
wire    process_ipv4_512_U0_m_axis_rx_meta_V_TVALID;
...
wire    ipv4_generate_ipv4_512_U0_s_axis_tx_meta_V_TREADY;
wire    local_ipv4_address_c1_full_n;
wire   [31:0] local_ipv4_address_c1_dout;
wire    local_ipv4_address_c1_empty_n;
wire    protocol_c2_full_n;
wire   [7:0] protocol_c2_dout;
wire    protocol_c2_empty_n;
...
ipv4_top_ipv4_top_entry3 ipv4_top_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
ipv4_top_ipv4_top_entry6 ipv4_top_entry6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
ipv4_top_convert_axis_to_net_axis_512_4 convert_axis_to_net_axis_512_4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
ipv4_top_convert_net_axis_to_axis_512_5 convert_net_axis_to_axis_512_5_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
ipv4_top_fifo_w32_d2_S local_ipv4_address_c1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
ipv4_top_fifo_w8_d2_S protocol_c2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign convert_axis_to_net_axis_512_4_U0_ap_continue = 1'b1;

assign convert_axis_to_net_axis_512_4_U0_ap_start = 1'b1;
...
assign ipv4_top_entry3_U0_ap_continue = 1'b1;

assign ipv4_top_entry3_U0_ap_start = 1'b1;

assign ipv4_top_entry6_U0_ap_continue = 1'b1;

assign ipv4_top_entry6_U0_ap_start = 1'b1;

assign m_axis_rx_data_TDATA = convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TDATA;

assign m_axis_rx_data_TKEEP = convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TKEEP;

assign m_axis_rx_data_TLAST = convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TLAST;

assign m_axis_rx_data_TSTRB = convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TSTRB;

assign m_axis_rx_data_TVALID = convert_net_axis_to_axis_512_5_U0_m_axis_rx_data_TVALID;

assign m_axis_rx_meta_V_TDATA = process_ipv4_512_U0_m_axis_rx_meta_V_TDATA;

assign m_axis_rx_meta_V_TVALID = process_ipv4_512_U0_m_axis_rx_meta_V_TVALID;
...
assign s_axis_rx_data_TREADY = convert_axis_to_net_axis_512_4_U0_s_axis_rx_data_TREADY;

assign s_axis_tx_data_TREADY = convert_axis_to_net_axis_512_U0_s_axis_tx_data_TREADY;

assign s_axis_tx_meta_V_TREADY = ipv4_generate_ipv4_512_U0_s_axis_tx_meta_V_TREADY;
