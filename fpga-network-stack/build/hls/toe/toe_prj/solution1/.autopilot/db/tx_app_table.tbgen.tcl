...
set Spec2ImplPortList { 
	txSar2txApp_ack_push { ap_fifo {  { txSar2txApp_ack_push_dout fifo_data 0 128 }  { txSar2txApp_ack_push_empty_n fifo_status 0 1 }  { txSar2txApp_ack_push_read fifo_update 1 1 } } }
	txApp2txSar_upd_req { ap_fifo {  { txApp2txSar_upd_req_dout fifo_data 0 96 }  { txApp2txSar_upd_req_empty_n fifo_status 0 1 }  { txApp2txSar_upd_req_read fifo_update 1 1 } } }
	txSar2txApp_upd_rsp { ap_fifo {  { txSar2txApp_upd_rsp_din fifo_data 1 128 }  { txSar2txApp_upd_rsp_full_n fifo_status 0 1 }  { txSar2txApp_upd_rsp_write fifo_update 1 1 } } }
}
