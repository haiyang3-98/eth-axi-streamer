...
set C_modelName {toe_top.entry3}
...
set portList { 
	...
	{ axis_data_count sc_in sc_lv 16 signal 0 } 
	{ axis_max_data_count sc_in sc_lv 16 signal 1 } 
	{ myIpAddress sc_in sc_lv 32 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "axis_data_count_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "axis_data_count_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "axis_max_data_count_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
