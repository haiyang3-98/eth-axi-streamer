...
set C_modelArgList {
	...
	{ rxEng_dataBuffer0 int 1024 regular {fifo 0 volatile } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rx_process2dropLengthFifo", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_dataBuffer0", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rxEng_dataBuffer0_dout sc_in sc_lv 1024 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer0_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer0", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	rxEng_dataBuffer0 { ap_fifo {  { rxEng_dataBuffer0_dout fifo_data 0 1024 }  { rxEng_dataBuffer0_empty_n fifo_status 0 1 }  { rxEng_dataBuffer0_read fifo_update 1 1 } } }
