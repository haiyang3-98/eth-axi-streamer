...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txBufferReadDataStitched_dout { I 1024 vector } txBufferReadDataStitched_empty_n { I 1 bit } txBufferReadDataStitched_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txEng_tcpPkgBuffer0_din { O 1024 vector } txEng_tcpPkgBuffer0_full_n { I 1 bit } txEng_tcpPkgBuffer0_write { O 1 bit } } \
} "
}
