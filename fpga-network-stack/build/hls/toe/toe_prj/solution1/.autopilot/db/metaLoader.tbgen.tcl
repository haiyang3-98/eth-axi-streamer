...
set Spec2ImplPortList { 
	eventEng2txEng_event { ap_fifo {  { eventEng2txEng_event_dout fifo_data 0 224 }  { eventEng2txEng_event_empty_n fifo_status 0 1 }  { eventEng2txEng_event_read fifo_update 1 1 } } }
	...
	txEng2txSar_upd_req { ap_fifo {  { txEng2txSar_upd_req_din fifo_data 1 128 }  { txEng2txSar_upd_req_full_n fifo_status 0 1 }  { txEng2txSar_upd_req_write fifo_update 1 1 } } }
	rxSar2txEng_rsp { ap_fifo {  { rxSar2txEng_rsp_dout fifo_data 0 96 }  { rxSar2txEng_rsp_empty_n fifo_status 0 1 }  { rxSar2txEng_rsp_read fifo_update 1 1 } } }
	txSar2txEng_upd_rsp { ap_fifo {  { txSar2txEng_upd_rsp_dout fifo_data 0 192 }  { txSar2txEng_upd_rsp_empty_n fifo_status 0 1 }  { txSar2txEng_upd_rsp_read fifo_update 1 1 } } }
	...
	txEng_tcpMetaFifo { ap_fifo {  { txEng_tcpMetaFifo_din fifo_data 1 160 }  { txEng_tcpMetaFifo_full_n fifo_status 0 1 }  { txEng_tcpMetaFifo_write fifo_update 1 1 } } }
	...
	txEng2timer_setRetransmitTimer { ap_fifo {  { txEng2timer_setRetransmitTimer_din fifo_data 1 64 }  { txEng2timer_setRetransmitTimer_full_n fifo_status 0 1 }  { txEng2timer_setRetransmitTimer_write fifo_update 1 1 } } }
	txMetaloader2memAccessBreakdown { ap_fifo {  { txMetaloader2memAccessBreakdown_din fifo_data 1 128 }  { txMetaloader2memAccessBreakdown_full_n fifo_status 0 1 }  { txMetaloader2memAccessBreakdown_write fifo_update 1 1 } } }
