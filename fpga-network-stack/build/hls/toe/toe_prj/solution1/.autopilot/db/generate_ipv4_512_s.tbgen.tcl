...
set C_modelArgList {
	...
	{ txEng_tcpPkgBuffer6 int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_ipMetaFifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "txEng_tcpPkgBuffer6", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ txEng_tcpPkgBuffer6_dout sc_in sc_lv 1024 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer6_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer6", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	txEng_tcpPkgBuffer6 { ap_fifo {  { txEng_tcpPkgBuffer6_dout fifo_data 0 1024 }  { txEng_tcpPkgBuffer6_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer6_read fifo_update 1 1 } } }
}
