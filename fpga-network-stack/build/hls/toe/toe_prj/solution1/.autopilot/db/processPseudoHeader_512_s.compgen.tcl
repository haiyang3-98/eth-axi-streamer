...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_dataBuffer2_dout { I 1024 vector } rxEng_dataBuffer2_empty_n { I 1 bit } rxEng_dataBuffer2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_dataBuffer3a_din { O 1024 vector } rxEng_dataBuffer3a_full_n { I 1 bit } rxEng_dataBuffer3a_write { O 1 bit } } \
} "
}
