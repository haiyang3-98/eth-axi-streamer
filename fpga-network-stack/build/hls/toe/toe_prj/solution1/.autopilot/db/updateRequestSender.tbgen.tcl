...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_session_upd_req_V", "interface" : "axis", "bitwidth" : 160, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axis_session_upd_req_V_TREADY sc_in sc_logic 1 outacc 0 } 
	...
	{ m_axis_session_upd_req_V_TDATA sc_out sc_lv 160 signal 0 } 
	{ m_axis_session_upd_req_V_TVALID sc_out sc_logic 1 outvld 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_session_upd_req_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_session_upd_req_V { axis {  { m_axis_session_upd_req_V_TREADY out_acc 0 1 }  { m_axis_session_upd_req_V_TDATA out_data 1 160 }  { m_axis_session_upd_req_V_TVALID out_vld 1 1 } } }
