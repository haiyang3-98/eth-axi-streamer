...
set Spec2ImplPortList { 
	...
	rxEng_dataBuffer3b { ap_fifo {  { rxEng_dataBuffer3b_dout fifo_data 0 1024 }  { rxEng_dataBuffer3b_empty_n fifo_status 0 1 }  { rxEng_dataBuffer3b_read fifo_update 1 1 } } }
	rxEng_dataBuffer3 { ap_fifo {  { rxEng_dataBuffer3_din fifo_data 1 1024 }  { rxEng_dataBuffer3_full_n fifo_status 0 1 }  { rxEng_dataBuffer3_write fifo_update 1 1 } } }
