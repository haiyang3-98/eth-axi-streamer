...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_fsmMetaDataFifo_dout { I 288 vector } rxEng_fsmMetaDataFifo_empty_n { I 1 bit } rxEng_fsmMetaDataFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2stateTable_upd_req_din { O 96 vector } rxEng2stateTable_upd_req_full_n { I 1 bit } rxEng2stateTable_upd_req_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2rxSar_upd_req_din { O 192 vector } rxEng2rxSar_upd_req_full_n { I 1 bit } rxEng2rxSar_upd_req_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2txSar_upd_req_din { O 192 vector } rxEng2txSar_upd_req_full_n { I 1 bit } rxEng2txSar_upd_req_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxSar2rxEng_upd_rsp_dout { I 192 vector } rxSar2rxEng_upd_rsp_empty_n { I 1 bit } rxSar2rxEng_upd_rsp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txSar2rxEng_upd_rsp_dout { I 160 vector } txSar2rxEng_upd_rsp_empty_n { I 1 bit } txSar2rxEng_upd_rsp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2timer_clearRetransmitTimer_din { O 32 vector } rxEng2timer_clearRetransmitTimer_full_n { I 1 bit } rxEng2timer_clearRetransmitTimer_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2rxApp_notification_din { O 96 vector } rxEng2rxApp_notification_full_n { I 1 bit } rxEng2rxApp_notification_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_fsmEventFifo_din { O 128 vector } rxEng_fsmEventFifo_full_n { I 1 bit } rxEng_fsmEventFifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conEstablishedFifo_din { O 96 vector } conEstablishedFifo_full_n { I 1 bit } conEstablishedFifo_write { O 1 bit } } \
} "
}
