...
set C_modelArgList {
	...
	{ rxEng_fsmMetaDataFifo int 288 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rxEng_metaDataFifo", "interface" : "fifo", "bitwidth" : 160, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "rxEng_fsmMetaDataFifo", "interface" : "fifo", "bitwidth" : 288, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rxEng_fsmMetaDataFifo_din sc_out sc_lv 288 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_fsmMetaDataFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":288, "type": "signal", "bundle":{"name": "rxEng_fsmMetaDataFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	rxEng_metaDataFifo { ap_fifo {  { rxEng_metaDataFifo_dout fifo_data 0 160 }  { rxEng_metaDataFifo_empty_n fifo_status 0 1 }  { rxEng_metaDataFifo_read fifo_update 1 1 } } }
	...
	rxEng_metaHandlerEventFifo { ap_fifo {  { rxEng_metaHandlerEventFifo_din fifo_data 1 224 }  { rxEng_metaHandlerEventFifo_full_n fifo_status 0 1 }  { rxEng_metaHandlerEventFifo_write fifo_update 1 1 } } }
	...
	rxEng2sLookup_req { ap_fifo {  { rxEng2sLookup_req_din fifo_data 1 128 }  { rxEng2sLookup_req_full_n fifo_status 0 1 }  { rxEng2sLookup_req_write fifo_update 1 1 } } }
	sLookup2rxEng_rsp { ap_fifo {  { sLookup2rxEng_rsp_dout fifo_data 0 32 }  { sLookup2rxEng_rsp_empty_n fifo_status 0 1 }  { sLookup2rxEng_rsp_read fifo_update 1 1 } } }
	rxEng_fsmMetaDataFifo { ap_fifo {  { rxEng_fsmMetaDataFifo_din fifo_data 1 288 }  { rxEng_fsmMetaDataFifo_full_n fifo_status 0 1 }  { rxEng_fsmMetaDataFifo_write fifo_update 1 1 } } }
}
