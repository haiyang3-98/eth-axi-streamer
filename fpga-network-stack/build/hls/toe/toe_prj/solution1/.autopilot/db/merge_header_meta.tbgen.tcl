...
set C_modelArgList {
	...
	{ rxEng_metaDataFifo int 160 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rxEng_headerMetaFifo", "interface" : "fifo", "bitwidth" : 160, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_metaDataFifo", "interface" : "fifo", "bitwidth" : 160, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rxEng_metaDataFifo_din sc_out sc_lv 160 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_metaDataFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":160, "type": "signal", "bundle":{"name": "rxEng_metaDataFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	rxEng_metaDataFifo { ap_fifo {  { rxEng_metaDataFifo_din fifo_data 1 160 }  { rxEng_metaDataFifo_full_n fifo_status 0 1 }  { rxEng_metaDataFifo_write fifo_update 1 1 } } }
