...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_txwrite_sts_V", "interface" : "axis", "bitwidth" : 40, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_axis_txwrite_sts_V_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ s_axis_txwrite_sts_V_TDATA sc_in sc_lv 40 signal 0 } 
	{ s_axis_txwrite_sts_V_TREADY sc_out sc_logic 1 inacc 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_txwrite_sts_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_txwrite_sts_V { axis {  { s_axis_txwrite_sts_V_TVALID in_vld 0 1 }  { s_axis_txwrite_sts_V_TDATA in_data 0 40 }  { s_axis_txwrite_sts_V_TREADY in_acc 1 1 } } }
	txApp_txEventCache { ap_fifo {  { txApp_txEventCache_dout fifo_data 0 128 }  { txApp_txEventCache_empty_n fifo_status 0 1 }  { txApp_txEventCache_read fifo_update 1 1 } } }
	txApp2txSar_push { ap_fifo {  { txApp2txSar_push_din fifo_data 1 64 }  { txApp2txSar_push_full_n fifo_status 0 1 }  { txApp2txSar_push_write fifo_update 1 1 } } }
}
