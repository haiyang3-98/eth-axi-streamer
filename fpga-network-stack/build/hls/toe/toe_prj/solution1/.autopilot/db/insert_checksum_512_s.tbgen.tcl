...
set portList { 
	...
	{ txEng_tcpPkgBuffer4_dout sc_in sc_lv 1024 signal 0 } 
	{ txEng_tcpPkgBuffer4_empty_n sc_in sc_logic 1 signal 0 } 
	{ txEng_tcpPkgBuffer4_read sc_out sc_logic 1 signal 0 } 
	{ txEng_tcpChecksumFifo_dout sc_in sc_lv 16 signal 2 } 
	{ txEng_tcpChecksumFifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ txEng_tcpChecksumFifo_read sc_out sc_logic 1 signal 2 } 
	{ txEng_tcpPkgBuffer5_din sc_out sc_lv 1024 signal 1 } 
	{ txEng_tcpPkgBuffer5_full_n sc_in sc_logic 1 signal 1 } 
	{ txEng_tcpPkgBuffer5_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer4 { ap_fifo {  { txEng_tcpPkgBuffer4_dout fifo_data 0 1024 }  { txEng_tcpPkgBuffer4_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer4_read fifo_update 1 1 } } }
	txEng_tcpPkgBuffer5 { ap_fifo {  { txEng_tcpPkgBuffer5_din fifo_data 1 1024 }  { txEng_tcpPkgBuffer5_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer5_write fifo_update 1 1 } } }
