...
set Spec2ImplPortList { 
	...
	txBufferReadDataStitched { ap_fifo {  { txBufferReadDataStitched_din fifo_data 1 1024 }  { txBufferReadDataStitched_full_n fifo_status 0 1 }  { txBufferReadDataStitched_write fifo_update 1 1 } } }
}
