...
set C_modelArgList {
	...
	{ rxEng2rxApp_notification int 96 regular {fifo 0 volatile } {global 0}  }
	{ timer2rxApp_notification int 96 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_notification_V", "interface" : "axis", "bitwidth" : 96, "direction" : "WRITEONLY"} , 
 	{ "Name" : "rxEng2rxApp_notification", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "timer2rxApp_notification", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rxEng2rxApp_notification_dout sc_in sc_lv 96 signal 1 } 
	{ rxEng2rxApp_notification_empty_n sc_in sc_logic 1 signal 1 } 
	{ rxEng2rxApp_notification_read sc_out sc_logic 1 signal 1 } 
	{ timer2rxApp_notification_dout sc_in sc_lv 96 signal 2 } 
	{ timer2rxApp_notification_empty_n sc_in sc_logic 1 signal 2 } 
	{ timer2rxApp_notification_read sc_out sc_logic 1 signal 2 } 
	{ m_axis_notification_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_notification_V_TDATA sc_out sc_lv 96 signal 0 } 
	{ m_axis_notification_V_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng2rxApp_notification_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "rxEng2rxApp_notification", "role": "dout" }} , 
 	...
 	{ "name": "timer2rxApp_notification_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "timer2rxApp_notification", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_notification_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_notification_V { axis {  { m_axis_notification_V_TREADY out_acc 0 1 }  { m_axis_notification_V_TDATA out_data 1 96 }  { m_axis_notification_V_TVALID out_vld 1 1 } } }
	rxEng2rxApp_notification { ap_fifo {  { rxEng2rxApp_notification_dout fifo_data 0 96 }  { rxEng2rxApp_notification_empty_n fifo_status 0 1 }  { rxEng2rxApp_notification_read fifo_update 1 1 } } }
	timer2rxApp_notification { ap_fifo {  { timer2rxApp_notification_dout fifo_data 0 96 }  { timer2rxApp_notification_empty_n fifo_status 0 1 }  { timer2rxApp_notification_read fifo_update 1 1 } } }
}
