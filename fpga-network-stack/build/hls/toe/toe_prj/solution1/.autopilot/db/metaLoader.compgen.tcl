...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { eventEng2txEng_event_dout { I 224 vector } eventEng2txEng_event_empty_n { I 1 bit } eventEng2txEng_event_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txEng2txSar_upd_req_din { O 128 vector } txEng2txSar_upd_req_full_n { I 1 bit } txEng2txSar_upd_req_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxSar2txEng_rsp_dout { I 96 vector } rxSar2txEng_rsp_empty_n { I 1 bit } rxSar2txEng_rsp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txSar2txEng_upd_rsp_dout { I 192 vector } txSar2txEng_upd_rsp_empty_n { I 1 bit } txSar2txEng_upd_rsp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txEng_tcpMetaFifo_din { O 160 vector } txEng_tcpMetaFifo_full_n { I 1 bit } txEng_tcpMetaFifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txEng2timer_setRetransmitTimer_din { O 64 vector } txEng2timer_setRetransmitTimer_full_n { I 1 bit } txEng2timer_setRetransmitTimer_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txMetaloader2memAccessBreakdown_din { O 128 vector } txMetaloader2memAccessBreakdown_full_n { I 1 bit } txMetaloader2memAccessBreakdown_write { O 1 bit } } \
} "
}
