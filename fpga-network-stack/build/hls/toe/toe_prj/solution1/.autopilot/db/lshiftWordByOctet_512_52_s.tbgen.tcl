...
set C_modelArgList {
	{ txEng_tcpPkgBuffer6 int 1024 regular {fifo 1 volatile } {global 1}  }
	{ txEng_tcpPkgBuffer5 int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_tcpPkgBuffer6", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer5", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer5_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer5", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer6_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer6", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer6 { ap_fifo {  { txEng_tcpPkgBuffer6_din fifo_data 1 1024 }  { txEng_tcpPkgBuffer6_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer6_write fifo_update 1 1 } } }
	txEng_tcpPkgBuffer5 { ap_fifo {  { txEng_tcpPkgBuffer5_dout fifo_data 0 1024 }  { txEng_tcpPkgBuffer5_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer5_read fifo_update 1 1 } } }
}
