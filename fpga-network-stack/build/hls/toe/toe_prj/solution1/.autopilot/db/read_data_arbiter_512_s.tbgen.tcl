...
set C_modelArgList {
	...
	{ txBufferReadDataStitched int 1024 regular {fifo 0 volatile } {global 0}  }
	{ txEng_tcpPkgBuffer0 int 1024 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "txEng_isDDRbypass", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txBufferReadDataStitched", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer0", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ txBufferReadDataStitched_dout sc_in sc_lv 1024 signal 1 } 
	...
	{ txEng_tcpPkgBuffer0_din sc_out sc_lv 1024 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txBufferReadDataStitched_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txBufferReadDataStitched", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer0", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	txBufferReadDataStitched { ap_fifo {  { txBufferReadDataStitched_dout fifo_data 0 1024 }  { txBufferReadDataStitched_empty_n fifo_status 0 1 }  { txBufferReadDataStitched_read fifo_update 1 1 } } }
	txEng_tcpPkgBuffer0 { ap_fifo {  { txEng_tcpPkgBuffer0_din fifo_data 1 1024 }  { txEng_tcpPkgBuffer0_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer0_write fifo_update 1 1 } } }
