...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    reset_level 1 \
    sync_rst true \
    corename {m_axis_txwrite_data} \
    metadata {  } \
    op interface \
    ports { m_axis_txwrite_data_TDATA { O 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_txwrite_data_TKEEP { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_txwrite_data_TSTRB { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_txwrite_data_TREADY { I 1 bit } m_axis_txwrite_data_TVALID { O 1 bit } m_axis_txwrite_data_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txBufferWriteData_internal_dout { I 1024 vector } txBufferWriteData_internal_empty_n { I 1 bit } txBufferWriteData_internal_read { O 1 bit } } \
} "
}
