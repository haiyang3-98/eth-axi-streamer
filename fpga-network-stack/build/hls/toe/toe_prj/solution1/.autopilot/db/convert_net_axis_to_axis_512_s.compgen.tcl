...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    reset_level 1 \
    sync_rst true \
    corename {m_axis_rx_data_rsp} \
    metadata {  } \
    op interface \
    ports { m_axis_rx_data_rsp_TDATA { O 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_data_rsp_TKEEP { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_data_rsp_TSTRB { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_data_rsp_TREADY { I 1 bit } m_axis_rx_data_rsp_TVALID { O 1 bit } m_axis_rx_data_rsp_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxDataRsp_internal_dout { I 1024 vector } rxDataRsp_internal_empty_n { I 1 bit } rxDataRsp_internal_read { O 1 bit } } \
} "
}
