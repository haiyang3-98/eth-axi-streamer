...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_txwrite_cmd_V", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ tasi_dataFifo_dout sc_in sc_lv 1024 signal 2 } 
	{ tasi_dataFifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ tasi_dataFifo_read sc_out sc_logic 1 signal 2 } 
	{ tasi_meta2pkgPushCmd_dout sc_in sc_lv 128 signal 1 } 
	...
	{ m_axis_txwrite_cmd_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_txwrite_cmd_V_TDATA sc_out sc_lv 128 signal 0 } 
	{ m_axis_txwrite_cmd_V_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_646_64_1_1_U373", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txwrite_cmd_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_txwrite_cmd_V { axis {  { m_axis_txwrite_cmd_V_TREADY out_acc 0 1 }  { m_axis_txwrite_cmd_V_TDATA out_data 1 128 }  { m_axis_txwrite_cmd_V_TVALID out_vld 1 1 } } }
	tasi_meta2pkgPushCmd { ap_fifo {  { tasi_meta2pkgPushCmd_dout fifo_data 0 128 }  { tasi_meta2pkgPushCmd_empty_n fifo_status 0 1 }  { tasi_meta2pkgPushCmd_read fifo_update 1 1 } } }
	tasi_dataFifo { ap_fifo {  { tasi_dataFifo_dout fifo_data 0 1024 }  { tasi_dataFifo_empty_n fifo_status 0 1 }  { tasi_dataFifo_read fifo_update 1 1 } } }
