...
set C_modelArgList {
	{ txEng_tcpMetaFifo int 160 regular {fifo 0 volatile } {global 0}  }
	{ txEng_tcpTupleFifo int 96 regular {fifo 0 volatile } {global 0}  }
	{ txEng_tcpPkgBuffer1 int 1024 regular {fifo 1 volatile } {global 1}  }
	{ txEng_shift2pseudoFifo int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_tcpMetaFifo", "interface" : "fifo", "bitwidth" : 160, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpTupleFifo", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txEng_shift2pseudoFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ txEng_tcpPkgBuffer1_din sc_out sc_lv 1024 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_shift2pseudoFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_shift2pseudoFifo", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpMetaFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":160, "type": "signal", "bundle":{"name": "txEng_tcpMetaFifo", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer1", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpMetaFifo { ap_fifo {  { txEng_tcpMetaFifo_dout fifo_data 0 160 }  { txEng_tcpMetaFifo_empty_n fifo_status 0 1 }  { txEng_tcpMetaFifo_read fifo_update 1 1 } } }
	...
	txEng_tcpPkgBuffer1 { ap_fifo {  { txEng_tcpPkgBuffer1_din fifo_data 1 1024 }  { txEng_tcpPkgBuffer1_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer1_write fifo_update 1 1 } } }
	txEng_shift2pseudoFifo { ap_fifo {  { txEng_shift2pseudoFifo_dout fifo_data 0 1024 }  { txEng_shift2pseudoFifo_empty_n fifo_status 0 1 }  { txEng_shift2pseudoFifo_read fifo_update 1 1 } } }
}
