...
set C_modelArgList {
	...
	{ sLookup2txApp_rsp int 32 regular {fifo 0 volatile } {global 0}  }
	{ txApp2eventEng_mergeEvent int 128 regular {fifo 1 volatile } {global 1}  }
	{ txApp2stateTable_upd_req int 96 regular {fifo 1 volatile } {global 1}  }
	{ conEstablishedFifo int 96 regular {fifo 0 volatile } {global 0}  }
	{ timer2txApp_notification int 96 regular {fifo 0 volatile } {global 0}  }
	{ stateTable2txApp_upd_rsp int 32 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_open_conn_req_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "s_axis_close_conn_req_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_open_conn_rsp_V", "interface" : "axis", "bitwidth" : 96, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "sLookup2txApp_rsp", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txApp2eventEng_mergeEvent", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txApp2stateTable_upd_req", "interface" : "fifo", "bitwidth" : 96, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "conEstablishedFifo", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "timer2txApp_notification", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ s_axis_open_conn_req_V_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ m_axis_open_conn_rsp_V_TREADY sc_in sc_logic 1 outacc 2 } 
	{ txApp2stateTable_upd_req_din sc_out sc_lv 96 signal 8 } 
	{ txApp2stateTable_upd_req_full_n sc_in sc_logic 1 signal 8 } 
	{ txApp2stateTable_upd_req_write sc_out sc_logic 1 signal 8 } 
	{ txApp2eventEng_mergeEvent_din sc_out sc_lv 128 signal 7 } 
	{ txApp2eventEng_mergeEvent_full_n sc_in sc_logic 1 signal 7 } 
	{ txApp2eventEng_mergeEvent_write sc_out sc_logic 1 signal 7 } 
	{ s_axis_open_conn_req_V_TDATA sc_in sc_lv 64 signal 0 } 
	{ s_axis_open_conn_req_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ s_axis_close_conn_req_V_TDATA sc_in sc_lv 16 signal 1 } 
	{ s_axis_close_conn_req_V_TREADY sc_out sc_logic 1 inacc 1 } 
	{ m_axis_open_conn_rsp_V_TDATA sc_out sc_lv 96 signal 2 } 
	{ m_axis_open_conn_rsp_V_TVALID sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "timer2txApp_notification_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "timer2txApp_notification", "role": "dout" }} , 
 	...
 	{ "name": "conEstablishedFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "conEstablishedFifo", "role": "dout" }} , 
 	...
 	{ "name": "sLookup2txApp_rsp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sLookup2txApp_rsp", "role": "dout" }} , 
 	...
 	{ "name": "txApp2stateTable_upd_req_din", "direction": "out", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "txApp2stateTable_upd_req", "role": "din" }} , 
 	...
 	{ "name": "txApp2eventEng_mergeEvent_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "txApp2eventEng_mergeEvent", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "myIpAddress", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_open_conn_req_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_close_conn_req_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_open_conn_rsp_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_open_conn_req_V { axis {  { s_axis_open_conn_req_V_TVALID in_vld 0 1 }  { s_axis_open_conn_req_V_TDATA in_data 0 64 }  { s_axis_open_conn_req_V_TREADY in_acc 1 1 } } }
	s_axis_close_conn_req_V { axis {  { s_axis_close_conn_req_V_TVALID in_vld 0 1 }  { s_axis_close_conn_req_V_TDATA in_data 0 16 }  { s_axis_close_conn_req_V_TREADY in_acc 1 1 } } }
	m_axis_open_conn_rsp_V { axis {  { m_axis_open_conn_rsp_V_TREADY out_acc 0 1 }  { m_axis_open_conn_rsp_V_TDATA out_data 1 96 }  { m_axis_open_conn_rsp_V_TVALID out_vld 1 1 } } }
	...
	sLookup2txApp_rsp { ap_fifo {  { sLookup2txApp_rsp_dout fifo_data 0 32 }  { sLookup2txApp_rsp_empty_n fifo_status 0 1 }  { sLookup2txApp_rsp_read fifo_update 1 1 } } }
	txApp2eventEng_mergeEvent { ap_fifo {  { txApp2eventEng_mergeEvent_din fifo_data 1 128 }  { txApp2eventEng_mergeEvent_full_n fifo_status 0 1 }  { txApp2eventEng_mergeEvent_write fifo_update 1 1 } } }
	txApp2stateTable_upd_req { ap_fifo {  { txApp2stateTable_upd_req_din fifo_data 1 96 }  { txApp2stateTable_upd_req_full_n fifo_status 0 1 }  { txApp2stateTable_upd_req_write fifo_update 1 1 } } }
	conEstablishedFifo { ap_fifo {  { conEstablishedFifo_dout fifo_data 0 96 }  { conEstablishedFifo_empty_n fifo_status 0 1 }  { conEstablishedFifo_read fifo_update 1 1 } } }
	timer2txApp_notification { ap_fifo {  { timer2txApp_notification_dout fifo_data 0 96 }  { timer2txApp_notification_empty_n fifo_status 0 1 }  { timer2txApp_notification_read fifo_update 1 1 } } }
