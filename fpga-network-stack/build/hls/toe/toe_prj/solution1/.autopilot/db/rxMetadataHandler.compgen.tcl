...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_metaDataFifo_dout { I 160 vector } rxEng_metaDataFifo_empty_n { I 1 bit } rxEng_metaDataFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_metaHandlerEventFifo_din { O 224 vector } rxEng_metaHandlerEventFifo_full_n { I 1 bit } rxEng_metaHandlerEventFifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2sLookup_req_din { O 128 vector } rxEng2sLookup_req_full_n { I 1 bit } rxEng2sLookup_req_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sLookup2rxEng_rsp_dout { I 32 vector } sLookup2rxEng_rsp_empty_n { I 1 bit } sLookup2rxEng_rsp_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng_fsmMetaDataFifo_din { O 288 vector } rxEng_fsmMetaDataFifo_full_n { I 1 bit } rxEng_fsmMetaDataFifo_write { O 1 bit } } \
} "
}
