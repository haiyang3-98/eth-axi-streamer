...
set Spec2ImplPortList { 
	rxEng2eventEng_setEvent { ap_fifo {  { rxEng2eventEng_setEvent_dout fifo_data 0 224 }  { rxEng2eventEng_setEvent_empty_n fifo_status 0 1 }  { rxEng2eventEng_setEvent_read fifo_update 1 1 } } }
	eventEng2ackDelay_event { ap_fifo {  { eventEng2ackDelay_event_din fifo_data 1 224 }  { eventEng2ackDelay_event_full_n fifo_status 0 1 }  { eventEng2ackDelay_event_write fifo_update 1 1 } } }
	timer2eventEng_setEvent { ap_fifo {  { timer2eventEng_setEvent_dout fifo_data 0 128 }  { timer2eventEng_setEvent_empty_n fifo_status 0 1 }  { timer2eventEng_setEvent_read fifo_update 1 1 } } }
	txApp2eventEng_setEvent { ap_fifo {  { txApp2eventEng_setEvent_dout fifo_data 0 128 }  { txApp2eventEng_setEvent_empty_n fifo_status 0 1 }  { txApp2eventEng_setEvent_read fifo_update 1 1 } } }
