...
set C_modelArgList {
	...
	{ rxApp2rxSar_upd_req int 96 regular {fifo 1 volatile } {global 1}  }
	{ rxSar2rxApp_upd_rsp int 96 regular {fifo 0 volatile } {global 0}  }
	{ rxBufferReadCmd int 1 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_rx_data_req_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_rx_data_rsp_metadata_V", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "rxApp2rxSar_upd_req", "interface" : "fifo", "bitwidth" : 96, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "rxSar2rxApp_upd_rsp", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ s_axis_rx_data_req_V_TVALID sc_in sc_logic 1 invld 0 } 
	{ rxSar2rxApp_upd_rsp_dout sc_in sc_lv 96 signal 3 } 
	{ rxSar2rxApp_upd_rsp_empty_n sc_in sc_logic 1 signal 3 } 
	{ rxSar2rxApp_upd_rsp_read sc_out sc_logic 1 signal 3 } 
	{ rxApp2rxSar_upd_req_din sc_out sc_lv 96 signal 2 } 
	{ rxApp2rxSar_upd_req_full_n sc_in sc_logic 1 signal 2 } 
	{ rxApp2rxSar_upd_req_write sc_out sc_logic 1 signal 2 } 
	{ m_axis_rx_data_rsp_metadata_V_TREADY sc_in sc_logic 1 outacc 1 } 
	...
	{ s_axis_rx_data_req_V_TDATA sc_in sc_lv 32 signal 0 } 
	{ s_axis_rx_data_req_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ m_axis_rx_data_rsp_metadata_V_TDATA sc_out sc_lv 16 signal 1 } 
	{ m_axis_rx_data_rsp_metadata_V_TVALID sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxSar2rxApp_upd_rsp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "rxSar2rxApp_upd_rsp", "role": "dout" }} , 
 	...
 	{ "name": "rxApp2rxSar_upd_req_din", "direction": "out", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "rxApp2rxSar_upd_req", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_data_req_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_rx_data_rsp_metadata_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_rx_data_req_V { axis {  { s_axis_rx_data_req_V_TVALID in_vld 0 1 }  { s_axis_rx_data_req_V_TDATA in_data 0 32 }  { s_axis_rx_data_req_V_TREADY in_acc 1 1 } } }
	m_axis_rx_data_rsp_metadata_V { axis {  { m_axis_rx_data_rsp_metadata_V_TREADY out_acc 0 1 }  { m_axis_rx_data_rsp_metadata_V_TDATA out_data 1 16 }  { m_axis_rx_data_rsp_metadata_V_TVALID out_vld 1 1 } } }
	rxApp2rxSar_upd_req { ap_fifo {  { rxApp2rxSar_upd_req_din fifo_data 1 96 }  { rxApp2rxSar_upd_req_full_n fifo_status 0 1 }  { rxApp2rxSar_upd_req_write fifo_update 1 1 } } }
	rxSar2rxApp_upd_rsp { ap_fifo {  { rxSar2rxApp_upd_rsp_dout fifo_data 0 96 }  { rxSar2rxApp_upd_rsp_empty_n fifo_status 0 1 }  { rxSar2rxApp_upd_rsp_read fifo_update 1 1 } } }
