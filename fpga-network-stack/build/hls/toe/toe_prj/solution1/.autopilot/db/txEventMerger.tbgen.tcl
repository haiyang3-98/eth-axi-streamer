...
set Spec2ImplPortList { 
	txApp2eventEng_mergeEvent { ap_fifo {  { txApp2eventEng_mergeEvent_dout fifo_data 0 128 }  { txApp2eventEng_mergeEvent_empty_n fifo_status 0 1 }  { txApp2eventEng_mergeEvent_read fifo_update 1 1 } } }
	txApp2eventEng_setEvent { ap_fifo {  { txApp2eventEng_setEvent_din fifo_data 1 128 }  { txApp2eventEng_setEvent_full_n fifo_status 0 1 }  { txApp2eventEng_setEvent_write fifo_update 1 1 } } }
	txAppStream2event_mergeEvent { ap_fifo {  { txAppStream2event_mergeEvent_dout fifo_data 0 128 }  { txAppStream2event_mergeEvent_empty_n fifo_status 0 1 }  { txAppStream2event_mergeEvent_read fifo_update 1 1 } } }
	txApp_txEventCache { ap_fifo {  { txApp_txEventCache_din fifo_data 1 128 }  { txApp_txEventCache_full_n fifo_status 0 1 }  { txApp_txEventCache_write fifo_update 1 1 } } }
}
