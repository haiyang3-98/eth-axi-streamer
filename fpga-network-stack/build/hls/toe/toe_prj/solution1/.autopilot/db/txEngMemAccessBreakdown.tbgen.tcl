...
set C_modelArgList {
	...
	{ txMetaloader2memAccessBreakdown int 128 regular {fifo 0 volatile } {global 0}  }
	{ memAccessBreakdown2txPkgStitcher int 1 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_txread_cmd_V", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "txMetaloader2memAccessBreakdown", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ txMetaloader2memAccessBreakdown_dout sc_in sc_lv 128 signal 1 } 
	...
	{ m_axis_txread_cmd_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_txread_cmd_V_TDATA sc_out sc_lv 128 signal 0 } 
	{ m_axis_txread_cmd_V_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txMetaloader2memAccessBreakdown_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "txMetaloader2memAccessBreakdown", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txread_cmd_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_txread_cmd_V { axis {  { m_axis_txread_cmd_V_TREADY out_acc 0 1 }  { m_axis_txread_cmd_V_TDATA out_data 1 128 }  { m_axis_txread_cmd_V_TVALID out_vld 1 1 } } }
	txMetaloader2memAccessBreakdown { ap_fifo {  { txMetaloader2memAccessBreakdown_dout fifo_data 0 128 }  { txMetaloader2memAccessBreakdown_empty_n fifo_status 0 1 }  { txMetaloader2memAccessBreakdown_read fifo_update 1 1 } } }
