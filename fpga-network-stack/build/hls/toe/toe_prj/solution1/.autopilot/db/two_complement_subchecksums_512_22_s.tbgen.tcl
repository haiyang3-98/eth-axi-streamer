...
set C_modelArgList {
	{ txEng_tcpPkgBuffer1 int 1024 regular {fifo 0 volatile } {global 0}  }
	{ txEng_tcpPkgBuffer2 int 1024 regular {fifo 1 volatile } {global 1}  }
	{ txEng_subChecksumsFifo int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_tcpPkgBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer2", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txEng_subChecksumsFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer1", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer2", "role": "din" }} , 
 	...
 	{ "name": "txEng_subChecksumsFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txEng_subChecksumsFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer1 { ap_fifo {  { txEng_tcpPkgBuffer1_dout fifo_data 0 1024 }  { txEng_tcpPkgBuffer1_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer1_read fifo_update 1 1 } } }
	txEng_tcpPkgBuffer2 { ap_fifo {  { txEng_tcpPkgBuffer2_din fifo_data 1 1024 }  { txEng_tcpPkgBuffer2_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer2_write fifo_update 1 1 } } }
	txEng_subChecksumsFifo { ap_fifo {  { txEng_subChecksumsFifo_din fifo_data 1 1024 }  { txEng_subChecksumsFifo_full_n fifo_status 0 1 }  { txEng_subChecksumsFifo_write fifo_update 1 1 } } }
}
