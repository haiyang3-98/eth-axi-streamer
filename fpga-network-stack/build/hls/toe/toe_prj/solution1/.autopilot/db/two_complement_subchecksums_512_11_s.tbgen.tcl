...
set C_modelArgList {
	{ rxEng_dataBuffer1 int 1024 regular {fifo 0 volatile } {global 0}  }
	{ rxEng_dataBuffer2 int 1024 regular {fifo 1 volatile } {global 1}  }
	{ subSumFifo int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rxEng_dataBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_dataBuffer2", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer1", "role": "dout" }} , 
 	...
 	{ "name": "rxEng_dataBuffer2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer2", "role": "din" }} , 
...
set Spec2ImplPortList { 
	rxEng_dataBuffer1 { ap_fifo {  { rxEng_dataBuffer1_dout fifo_data 0 1024 }  { rxEng_dataBuffer1_empty_n fifo_status 0 1 }  { rxEng_dataBuffer1_read fifo_update 1 1 } } }
	rxEng_dataBuffer2 { ap_fifo {  { rxEng_dataBuffer2_din fifo_data 1 1024 }  { rxEng_dataBuffer2_full_n fifo_status 0 1 }  { rxEng_dataBuffer2_write fifo_update 1 1 } } }
