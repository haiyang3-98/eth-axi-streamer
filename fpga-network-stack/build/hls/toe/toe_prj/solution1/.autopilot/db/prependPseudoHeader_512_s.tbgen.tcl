...
set C_modelArgList {
	...
	{ rxEng_dataBuffer1 int 1024 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rxEng_pseudoHeaderFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_dataBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rxEng_dataBuffer1_din sc_out sc_lv 1024 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer1", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	rxEng_dataBuffer1 { ap_fifo {  { rxEng_dataBuffer1_din fifo_data 1 1024 }  { rxEng_dataBuffer1_full_n fifo_status 0 1 }  { rxEng_dataBuffer1_write fifo_update 1 1 } } }
