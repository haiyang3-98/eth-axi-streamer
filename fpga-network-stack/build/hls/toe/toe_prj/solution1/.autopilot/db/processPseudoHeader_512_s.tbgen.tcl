...
set C_modelArgList {
	{ rxEng_dataBuffer2 int 1024 regular {fifo 0 volatile } {global 0}  }
	{ rxEng_checksumValidFifo int 1 regular {fifo 0 volatile } {global 0}  }
	{ rxEng_dataBuffer3a int 1024 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rxEng_dataBuffer2", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_checksumValidFifo", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rxEng_dataBuffer3a", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rxEng_dataBuffer2_dout sc_in sc_lv 1024 signal 0 } 
	...
	{ rxEng_dataBuffer3a_din sc_out sc_lv 1024 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer2", "role": "dout" }} , 
 	...
 	{ "name": "rxEng_dataBuffer3a_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxEng_dataBuffer3a", "role": "din" }} , 
...
set Spec2ImplPortList { 
	rxEng_dataBuffer2 { ap_fifo {  { rxEng_dataBuffer2_dout fifo_data 0 1024 }  { rxEng_dataBuffer2_empty_n fifo_status 0 1 }  { rxEng_dataBuffer2_read fifo_update 1 1 } } }
	...
	rxEng_dataBuffer3a { ap_fifo {  { rxEng_dataBuffer3a_din fifo_data 1 1024 }  { rxEng_dataBuffer3a_full_n fifo_status 0 1 }  { rxEng_dataBuffer3a_write fifo_update 1 1 } } }
