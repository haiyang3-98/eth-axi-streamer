...
set ID 122
set hasByteEnable 0
set MemName toe_top_state_table_state_table_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txApp2stateTable_upd_req_dout { I 96 vector } txApp2stateTable_upd_req_empty_n { I 1 bit } txApp2stateTable_upd_req_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2stateTable_upd_req_dout { I 96 vector } rxEng2stateTable_upd_req_empty_n { I 1 bit } rxEng2stateTable_upd_req_read { O 1 bit } } \
} "
}
