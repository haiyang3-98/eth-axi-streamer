...
module toe_top_convert_axis_to_net_axis_512_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ipRxData_internal_din,
        ipRxData_internal_full_n,
        ipRxData_internal_write,
...
output  [1023:0] ipRxData_internal_din;
input   ipRxData_internal_full_n;
output   ipRxData_internal_write;
...
wire   [511:0] s_axis_tcp_data_TDATA_int_regslice;
...
wire   [63:0] s_axis_tcp_data_TKEEP_int_regslice;
...
wire   [63:0] s_axis_tcp_data_TSTRB_int_regslice;
...
wire   [0:0] s_axis_tcp_data_TLAST_int_regslice;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_91 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ipRxData_internal_write = 1'b1;
    end else begin
        ipRxData_internal_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (ipRxData_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_tcp_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (ipRxData_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_tcp_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (ipRxData_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_tcp_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_tcp_data_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_91 == 1'd1) & (ipRxData_internal_full_n == 1'b0));
end
...
assign ipRxData_internal_din = tmp_s_fu_79_p4;

assign s_axis_tcp_data_TREADY = regslice_both_input_V_data_V_U_ack_in;

assign tmp_nbreadreq_fu_34_p6 = s_axis_tcp_data_TVALID_int_regslice;

assign tmp_s_fu_79_p4 = {{{ref_tmp_last_reg_105}, {ref_tmp_keep_reg_100}}, {ref_tmp_data_reg_95}};

endmodule //toe_top_convert_axis_to_net_axis_512_16
