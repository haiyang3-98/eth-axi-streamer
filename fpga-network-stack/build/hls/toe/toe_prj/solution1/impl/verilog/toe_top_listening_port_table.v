...
wire   [0:0] tmp_i_284_nbreadreq_fu_64_p3;
reg    ap_predicate_op31_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
wire    ap_block_state4_pp0_stage0_iter3;
reg   [0:0] tmp_i_reg_175_pp0_iter3_reg;
reg   [0:0] tmp_i_284_reg_194;
reg   [0:0] tmp_i_284_reg_194_pp0_iter3_reg;
...
reg   [0:0] tmp_i_284_reg_194_pp0_iter2_reg;
...
wire   [63:0] zext_ln534_fu_140_p1;
wire   [63:0] zext_ln708_fu_144_p1;
wire   [63:0] zext_ln534_16_fu_171_p1;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] xor_ln878_fu_148_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (tmp_i_284_reg_194_pp0_iter2_reg == 1'd1) & (tmp_i_reg_175_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ...
        end else if (((tmp_i_284_reg_194 == 1'd1) & (tmp_i_reg_175_pp0_iter1_reg == 1'd0))) begin
            listeningPortTable_address1 = zext_ln534_fu_140_p1;
        end else begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_i_reg_175_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_i_284_reg_194 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_i_reg_175_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op55_write_state5 == 1'b1)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op53_write_state5 == 1'b1)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op48_write_state5 == 1'b1)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_predicate_op55_write_state5 == 1'b1)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_predicate_op53_write_state5 == 1'b1)))) begin
        portTable2rxApp_listen_rsp_din = 1'd1;
    end else if (((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_predicate_op48_write_state5 == 1'b1))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op55_write_state5 == 1'b1)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op53_write_state5 == 1'b1)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op48_write_state5 == 1'b1)))) begin
...
always @ (*) begin
    if (((ap_predicate_op46_write_state5 == 1'b1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_predicate_op46_write_state5 == 1'b1) & (ap_enable_reg_pp0_iter4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_i_nbreadreq_fu_50_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0))) begin
...
assign and_ln63_fu_153_p2 = (xor_ln878_fu_148_p2 & listeningPortTable_q1);

assign and_ln67_fu_165_p2 = (xor_ln878_fu_148_p2 & xor_ln67_fu_159_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_predicate_op31_read_state2 == 1'b1) & (pt_portCheckListening_req_fifo_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_i_nbreadreq_fu_50_p3 == 1'd1) & (rxApp2portTable_listen_req_empty_n == 1'b0)))) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (((portTable2rxApp_listen_rsp_full_n == 1'b0) & (ap_predicate_op55_write_state5 == 1'b1)) | ((portTable2rxApp_listen_rsp_full_n == 1'b0) & (ap_predicate_op53_write_state5 == 1'b1)) | ((portTable2rxApp_listen_rsp_full_n == 1'b0) & (ap_predicate_op48_write_state5 == 1'b1)) | ((ap_predicate_op46_write_state5 == 1'b1) & (pt_portCheckListening_rsp_fifo_full_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op31_read_state2 == 1'b1) & (pt_portCheckListening_req_fifo_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_enable_operation_37 = (tmp_i_reg_175_pp0_iter1_reg == 1'd1);
end
...
always @ (*) begin
    ap_enable_operation_39 = (tmp_i_reg_175_pp0_iter2_reg == 1'd1);
end
...
always @ (*) begin
    ap_predicate_op31_read_state2 = ((tmp_i_284_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_reg_175 == 1'd0));
end

always @ (*) begin
    ap_predicate_op34_load_state3 = ((tmp_i_284_reg_194 == 1'd1) & (tmp_i_reg_175_pp0_iter1_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op38_load_state4 = ((tmp_i_284_reg_194_pp0_iter2_reg == 1'd1) & (tmp_i_reg_175_pp0_iter2_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op46_write_state5 = ((tmp_i_284_reg_194_pp0_iter3_reg == 1'd1) & (tmp_i_reg_175_pp0_iter3_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op48_write_state5 = ((tmp_i_reg_175_pp0_iter3_reg == 1'd1) & (1'd0 == and_ln67_reg_222) & (1'd0 == and_ln63_reg_218));
end

always @ (*) begin
    ap_predicate_op52_store_state5 = ((tmp_i_reg_175_pp0_iter3_reg == 1'd1) & (1'd0 == and_ln63_reg_218) & (1'd1 == and_ln67_reg_222));
end

always @ (*) begin
    ap_predicate_op53_write_state5 = ((tmp_i_reg_175_pp0_iter3_reg == 1'd1) & (1'd0 == and_ln63_reg_218) & (1'd1 == and_ln67_reg_222));
end

always @ (*) begin
    ap_predicate_op55_write_state5 = ((tmp_i_reg_175_pp0_iter3_reg == 1'd1) & (1'd1 == and_ln63_reg_218));
end

assign listeningPortTable_address0 = zext_ln534_16_fu_171_p1;

assign pt_portCheckListening_rsp_fifo_din = listeningPortTable_load_1_reg_213;

assign tmp_i_284_nbreadreq_fu_64_p3 = pt_portCheckListening_req_fifo_empty_n;
...
assign xor_ln878_fu_148_p2 = (tmp_reg_189_pp0_iter2_reg ^ 1'd1);

assign zext_ln534_16_fu_171_p1 = currPort_V_reg_179_pp0_iter3_reg;

assign zext_ln534_fu_140_p1 = tmp_V_reg_198;
