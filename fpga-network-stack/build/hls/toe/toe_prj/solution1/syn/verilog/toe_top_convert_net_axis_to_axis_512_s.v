...
module toe_top_convert_net_axis_to_axis_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_idle,
        ap_ready,
        rxDataRsp_internal_dout,
        rxDataRsp_internal_empty_n,
        rxDataRsp_internal_read,
...
output   ap_idle;
output   ap_ready;
input  [1023:0] rxDataRsp_internal_dout;
input   rxDataRsp_internal_empty_n;
output   rxDataRsp_internal_read;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_nbreadreq_fu_44_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_365_reg_111 <= rxDataRsp_internal_dout[32'd576];
        tmp_i_keep_reg_106 <= {{rxDataRsp_internal_dout[575:512]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_nbreadreq_fu_44_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        rxDataRsp_internal_read = 1'b1;
    end else begin
        rxDataRsp_internal_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_output_V_data_V_U_apdone_blk == 1'b1) | ((tmp_reg_97_pp0_iter1_reg == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0)))) | ((tmp_reg_97 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_44_p3 == 1'd1) & (rxDataRsp_internal_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_output_V_data_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((tmp_reg_97_pp0_iter1_reg == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((tmp_reg_97 == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_44_p3 == 1'd1) & (rxDataRsp_internal_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_44_p3 == 1'd1) & (rxDataRsp_internal_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_io = ((tmp_reg_97 == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_97 == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((tmp_reg_97_pp0_iter1_reg == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((regslice_both_output_V_data_V_U_apdone_blk == 1'b1) | ((tmp_reg_97_pp0_iter1_reg == 1'd1) & (m_axis_rx_data_rsp_TREADY_int_regslice == 1'b0)));
end
...
assign m_axis_rx_data_rsp_TVALID = regslice_both_output_V_data_V_U_vld_out;

assign tmp_nbreadreq_fu_44_p3 = rxDataRsp_internal_empty_n;

assign trunc_ln83_fu_75_p1 = rxDataRsp_internal_dout[511:0];

endmodule //toe_top_convert_net_axis_to_axis_512_s
