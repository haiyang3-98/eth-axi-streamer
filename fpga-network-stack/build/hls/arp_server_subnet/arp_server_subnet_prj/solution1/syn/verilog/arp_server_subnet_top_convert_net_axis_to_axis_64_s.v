...
module arp_server_subnet_top_convert_net_axis_to_axis_64_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_idle,
        ap_ready,
        arpDataOut_internal_dout,
        arpDataOut_internal_empty_n,
        arpDataOut_internal_read,
        m_axis_TREADY,
        m_axis_TDATA,
        m_axis_TVALID,
        m_axis_TKEEP,
...
output   ap_idle;
output   ap_ready;
input  [127:0] arpDataOut_internal_dout;
input   arpDataOut_internal_empty_n;
output   arpDataOut_internal_read;
input   m_axis_TREADY;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_9_reg_111 <= arpDataOut_internal_dout[32'd72];
        tmp_i_keep_i_reg_106 <= {{arpDataOut_internal_dout[71:64]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arpDataOut_internal_read = 1'b1;
    end else begin
        arpDataOut_internal_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (arpDataOut_internal_empty_n == 1'b0)));
end
...
assign tmp_i_nbreadreq_fu_44_p3 = arpDataOut_internal_empty_n;

assign trunc_ln83_fu_75_p1 = arpDataOut_internal_dout[63:0];

endmodule //arp_server_subnet_top_convert_net_axis_to_axis_64_s
