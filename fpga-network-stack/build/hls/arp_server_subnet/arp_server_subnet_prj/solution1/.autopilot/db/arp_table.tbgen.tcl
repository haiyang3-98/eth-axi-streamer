...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_arp_lookup_request_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "s_axis_host_arp_lookup_request_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_arp_lookup_reply_V", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m_axis_host_arp_lookup_reply_V", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ s_axis_host_arp_lookup_request_V_TVALID sc_in sc_logic 1 invld 1 } 
	{ s_axis_arp_lookup_request_V_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ m_axis_host_arp_lookup_reply_V_TREADY sc_in sc_logic 1 outacc 3 } 
	{ m_axis_arp_lookup_reply_V_TREADY sc_in sc_logic 1 outacc 2 } 
	...
	{ s_axis_arp_lookup_request_V_TDATA sc_in sc_lv 32 signal 0 } 
	{ s_axis_arp_lookup_request_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ s_axis_host_arp_lookup_request_V_TDATA sc_in sc_lv 32 signal 1 } 
	{ s_axis_host_arp_lookup_request_V_TREADY sc_out sc_logic 1 inacc 1 } 
	{ m_axis_arp_lookup_reply_V_TDATA sc_out sc_lv 128 signal 2 } 
	{ m_axis_arp_lookup_reply_V_TVALID sc_out sc_logic 1 outvld 2 } 
	{ m_axis_host_arp_lookup_reply_V_TDATA sc_out sc_lv 128 signal 3 } 
	{ m_axis_host_arp_lookup_reply_V_TVALID sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_arp_lookup_request_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_host_arp_lookup_request_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_arp_lookup_reply_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_host_arp_lookup_reply_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_arp_lookup_request_V { axis {  { s_axis_arp_lookup_request_V_TVALID in_vld 0 1 }  { s_axis_arp_lookup_request_V_TDATA in_data 0 32 }  { s_axis_arp_lookup_request_V_TREADY in_acc 1 1 } } }
	s_axis_host_arp_lookup_request_V { axis {  { s_axis_host_arp_lookup_request_V_TVALID in_vld 0 1 }  { s_axis_host_arp_lookup_request_V_TDATA in_data 0 32 }  { s_axis_host_arp_lookup_request_V_TREADY in_acc 1 1 } } }
	m_axis_arp_lookup_reply_V { axis {  { m_axis_arp_lookup_reply_V_TREADY out_acc 0 1 }  { m_axis_arp_lookup_reply_V_TDATA out_data 1 128 }  { m_axis_arp_lookup_reply_V_TVALID out_vld 1 1 } } }
	m_axis_host_arp_lookup_reply_V { axis {  { m_axis_host_arp_lookup_reply_V_TREADY out_acc 0 1 }  { m_axis_host_arp_lookup_reply_V_TDATA out_data 1 128 }  { m_axis_host_arp_lookup_reply_V_TVALID out_vld 1 1 } } }
	arpTableInsertFifo { ap_fifo {  { arpTableInsertFifo_dout fifo_data 0 192 }  { arpTableInsertFifo_empty_n fifo_status 0 1 }  { arpTableInsertFifo_read fifo_update 1 1 } } }
