set moduleName arp_server_subnet_top_entry7
set isTopModule 0
...
set C_modelName {arp_server_subnet_top.entry7}
...
set portList { 
	...
	{ myMacAddress_out_din sc_out sc_lv 48 signal 2 } 
	{ myMacAddress_out_full_n sc_in sc_logic 1 signal 2 } 
	{ myMacAddress_out_write sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "myMacAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "myMacAddress_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "myIpAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
