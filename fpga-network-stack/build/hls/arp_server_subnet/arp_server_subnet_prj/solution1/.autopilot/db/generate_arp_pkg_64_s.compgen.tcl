...
set id 34
set name arp_server_subnet_top_mux_646_64_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpReplyMetaFifo_dout { I 192 vector } arpReplyMetaFifo_empty_n { I 1 bit } arpReplyMetaFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpDataOut_internal_din { O 128 vector } arpDataOut_internal_full_n { I 1 bit } arpDataOut_internal_write { O 1 bit } } \
} "
}
