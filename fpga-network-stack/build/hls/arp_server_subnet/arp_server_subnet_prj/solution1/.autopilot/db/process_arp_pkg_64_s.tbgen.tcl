set moduleName process_arp_pkg_64_s
set isTopModule 0
...
set C_modelName {process_arp_pkg<64>}
...
set C_modelArgList {
	...
	{ arpDataIn_internal int 128 regular {fifo 0 volatile } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "regRequestCount", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "arpDataIn_internal", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ arpDataIn_internal_dout sc_in sc_lv 128 signal 4 } 
	{ arpDataIn_internal_empty_n sc_in sc_logic 1 signal 4 } 
	{ arpDataIn_internal_read sc_out sc_logic 1 signal 4 } 
	...
	{ myIpAddress_out_din sc_out sc_lv 32 signal 3 } 
	{ myIpAddress_out_full_n sc_in sc_logic 1 signal 3 } 
	{ myIpAddress_out_write sc_out sc_logic 1 signal 3 } 
	{ arpTableInsertFifo_din sc_out sc_lv 192 signal 6 } 
	{ arpTableInsertFifo_full_n sc_in sc_logic 1 signal 6 } 
	{ arpTableInsertFifo_write sc_out sc_logic 1 signal 6 } 
	{ arpReplyMetaFifo_din sc_out sc_lv 192 signal 5 } 
	{ arpReplyMetaFifo_full_n sc_in sc_logic 1 signal 5 } 
	{ arpReplyMetaFifo_write sc_out sc_logic 1 signal 5 } 
	{ regRequestCount sc_out sc_lv 16 signal 0 } 
	{ regRequestCount_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ regReplyCount sc_out sc_lv 16 signal 1 } 
	{ regReplyCount_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arpDataIn_internal_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "arpDataIn_internal", "role": "dout" }} , 
 	{ "name": "arpDataIn_internal_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arpDataIn_internal", "role": "empty_n" }} , 
 	{ "name": "arpDataIn_internal_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arpDataIn_internal", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "myIpAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "myIpAddress_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arpDataIn_internal", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	arpDataIn_internal { ap_fifo {  { arpDataIn_internal_dout fifo_data 0 128 }  { arpDataIn_internal_empty_n fifo_status 0 1 }  { arpDataIn_internal_read fifo_update 1 1 } } }
	arpReplyMetaFifo { ap_fifo {  { arpReplyMetaFifo_din fifo_data 1 192 }  { arpReplyMetaFifo_full_n fifo_status 0 1 }  { arpReplyMetaFifo_write fifo_update 1 1 } } }
	arpTableInsertFifo { ap_fifo {  { arpTableInsertFifo_din fifo_data 1 192 }  { arpTableInsertFifo_full_n fifo_status 0 1 }  { arpTableInsertFifo_write fifo_update 1 1 } } }
}
set moduleName process_arp_pkg_64_s
set isTopModule 0
set isCombinational 0
