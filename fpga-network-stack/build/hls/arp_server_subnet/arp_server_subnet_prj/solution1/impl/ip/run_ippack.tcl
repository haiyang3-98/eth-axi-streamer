...
## IP Info
set Vendor      "ethz.systems.fpga"
set Library     "hls"
set IPName      "arp_server_subnet"
set Version     "1.1"
set DisplayName "ARP Subnet Server"
set Revision    "2112600354"
set Description "Replies to ARP queries and resolves IP addresses."
...
set xo_kernel_name "arp_server_subnet_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/arp_server_subnet/arp_server_subnet_prj/solution1"
set debug_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/arp_server_subnet/arp_server_subnet_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {arp_server_subnet_top_regslice_both
...
arp_server_subnet_top_regslice_both
arp_server_subnet_top_regslice_both
arp_server_subnet_top_fifo_w48_d2_S
arp_server_subnet_top_fifo_w32_d2_S
arp_server_subnet_top_fifo_w48_d4_S
arp_server_subnet_top_fifo_w32_d3_S
arp_server_subnet_top_fifo_w128_d2_S
arp_server_subnet_top_fifo_w128_d2_S
arp_server_subnet_top_fifo_w32_d2_S
arp_server_subnet_top_fifo_w192_d4_S
arp_server_subnet_top_fifo_w192_d4_S
arp_server_subnet_top_fifo_w32_d4_S
...
## Variables
set Top "arp_server_subnet_top"
set TopNoPrefix "arp_server_subnet_top"
...
set Interfaces {
    ...
    s_axis_arp_lookup_request_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_arp_lookup_request_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_host_arp_lookup_request_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_host_arp_lookup_request_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    m_axis_arp_lookup_reply_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_arp_lookup_reply_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    m_axis_host_arp_lookup_reply_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_host_arp_lookup_reply_V"
        has_tready "1"
        ports {
            TDATA 128
        }
    ...
    ap_clk {
        ...
        buses "s_axis s_axis_arp_lookup_request_V s_axis_host_arp_lookup_request_V m_axis m_axis_arp_lookup_reply_V m_axis_host_arp_lookup_reply_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 6.4 machine 64 combinational 0 latency 7 II x}
