...
module arp_server_subnet_top_convert_axis_to_net_axis_64_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_ready,
        s_axis_TVALID,
        arpDataIn_internal_din,
        arpDataIn_internal_full_n,
        arpDataIn_internal_write,
        s_axis_TDATA,
        s_axis_TREADY,
        s_axis_TKEEP,
        s_axis_TSTRB,
...
output   ap_ready;
input   s_axis_TVALID;
output  [127:0] arpDataIn_internal_din;
input   arpDataIn_internal_full_n;
output   arpDataIn_internal_write;
...
reg   [63:0] ref_tmp_data_i_reg_95;
reg   [7:0] ref_tmp_keep_i_reg_100;
reg   [0:0] ref_tmp_last_i_reg_105;
reg    ap_block_pp0_stage0_subdone;
reg    ap_block_pp0_stage0_01001;
wire   [72:0] tmp_13_i_fu_79_p4;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_91 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arpDataIn_internal_write = 1'b1;
    end else begin
        arpDataIn_internal_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (arpDataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_91 == 1'd1) & (arpDataIn_internal_full_n == 1'b0));
end
...
assign arpDataIn_internal_din = tmp_13_i_fu_79_p4;

assign s_axis_TREADY = regslice_both_input_V_data_V_U_ack_in;

assign tmp_13_i_fu_79_p4 = {{{ref_tmp_last_i_reg_105}, {ref_tmp_keep_i_reg_100}}, {ref_tmp_data_i_reg_95}};

assign tmp_nbreadreq_fu_34_p6 = s_axis_TVALID_int_regslice;

endmodule //arp_server_subnet_top_convert_axis_to_net_axis_64_s
