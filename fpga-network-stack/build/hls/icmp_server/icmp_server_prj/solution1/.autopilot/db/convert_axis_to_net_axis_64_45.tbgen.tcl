set moduleName convert_axis_to_net_axis_64_45
set isTopModule 0
...
set C_modelName {convert_axis_to_net_axis<64>45}
...
set C_modelArgList {
	...
	{ dataIn_internal int 128 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dataIn_internal", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ dataIn_internal_din sc_out sc_lv 128 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dataIn_internal_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "dataIn_internal", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	dataIn_internal { ap_fifo {  { dataIn_internal_din fifo_data 1 128 }  { dataIn_internal_full_n fifo_status 0 1 }  { dataIn_internal_write fifo_update 1 1 } } }
}
