...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { packageBuffer1_din { O 128 vector } packageBuffer1_full_n { I 1 bit } packageBuffer1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { checksumStreams_V_V_0_din { O 16 vector } checksumStreams_V_V_0_full_n { I 1 bit } checksumStreams_V_V_0_write { O 1 bit } } \
} "
}
