...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_TDATA { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_TREADY { I 1 bit } m_axis_TVALID { O 1 bit } m_axis_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dataOut_internal_dout { I 128 vector } dataOut_internal_empty_n { I 1 bit } dataOut_internal_read { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 33
set RegSliceName icmp_server_top_regslice_both
set RegSliceInstName icmp_server_top_regslice_both_U
set CoreName ap_simcore_icmp_server_top_regslice_both
