...
set C_modelArgList {
	{ input_V_data_V int 64 regular {axi_s 0 volatile  { ttlIn Data } }  }
	{ input_V_keep_V int 8 regular {axi_s 0 volatile  { ttlIn Keep } }  }
	{ input_V_strb_V int 8 regular {axi_s 0 volatile  { ttlIn Strb } }  }
	{ input_V_last_V int 1 regular {axi_s 0 volatile  { ttlIn Last } }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ttlIn_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "input_V_last_V", "role": "default" }} , 
 	...
 	{ "name": "ttlIn_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_V_data_V", "role": "default" }} , 
 	{ "name": "ttlIn_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "input_V_last_V", "role": "default" }} , 
 	{ "name": "ttlIn_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "input_V_keep_V", "role": "default" }} , 
 	{ "name": "ttlIn_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "input_V_strb_V", "role": "default" }} , 
 	{ "name": "ttlIn_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "input_V_last_V", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	input_V_data_V { axis {  { ttlIn_TDATA in_data 0 64 } } }
	input_V_keep_V { axis {  { ttlIn_TKEEP in_data 0 8 } } }
	input_V_strb_V { axis {  { ttlIn_TSTRB in_data 0 8 } } }
	input_V_last_V { axis {  { ttlIn_TVALID in_vld 0 1 }  { ttlIn_TREADY in_acc 1 1 }  { ttlIn_TLAST in_data 0 1 } } }
