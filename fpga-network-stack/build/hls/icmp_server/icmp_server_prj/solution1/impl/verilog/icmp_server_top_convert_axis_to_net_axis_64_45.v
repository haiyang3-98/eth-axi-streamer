...
module icmp_server_top_convert_axis_to_net_axis_64_45 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input   s_axis_TVALID;
output  [127:0] dataIn_internal_din;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_TVALID_int_regslice == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_91 == 1'd1) & (dataIn_internal_full_n == 1'b0));
end
...
assign dataIn_internal_din = tmp_s_fu_79_p4;
...
endmodule //icmp_server_top_convert_axis_to_net_axis_64_45
