    ...
    wire [32:0] in_chan_dep_data_vec_4;
    ...
    wire [32:0] in_chan_dep_data_vec_5;
    ...
    // Process: mac_ip_encode_top_entry3_U0
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 0, 1, 1) mac_ip_encode_top_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~mac_ip_encode_top_entry3_U0.myMacAddress_out_blk_n) | (~mac_ip_encode_top_entry3_U0.regSubNetMask_out_blk_n) | (~mac_ip_encode_top_entry3_U0.regDefaultGateway_out_blk_n);
    ...
    // Process: mac_ip_encode_top_entry12_U0
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 1, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~mac_ip_encode_top_entry12_U0.myMacAddress_blk_n) | (~mac_ip_encode_top_entry12_U0.regSubNetMask_blk_n) | (~mac_ip_encode_top_entry12_U0.regDefaultGateway_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~mac_ip_encode_top_entry12_U0.myMacAddress_out_blk_n);
    ...
    assign proc_1_data_FIFO_blk[2] = 1'b0 | (~mac_ip_encode_top_entry12_U0.regSubNetMask_out_blk_n) | (~mac_ip_encode_top_entry12_U0.regDefaultGateway_out_blk_n);
    ...
    assign in_chan_dep_data_vec_1[21 : 11] = dep_chan_data_4_1;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 2, 1, 1) mac_ip_encode_top_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~convert_axis_to_net_axis_512_U0.dataIn_internal_blk_n);
    ...
    assign in_chan_dep_data_vec_2[10 : 0] = dep_chan_data_4_2;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 3, 1, 1) mac_ip_encode_top_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~convert_net_axis_to_axis_512_U0.dataOut_internal_blk_n);
    ...
    assign in_chan_dep_data_vec_3[10 : 0] = dep_chan_data_10_3;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 4, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_4 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~extract_ip_address_512_U0.regSubNetMask_blk_n) | (~extract_ip_address_512_U0.regDefaultGateway_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~extract_ip_address_512_U0.dataIn_internal_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~extract_ip_address_512_U0.dataStreamBuffer0_blk_n);
    ...
    assign in_chan_dep_data_vec_4[10 : 0] = dep_chan_data_1_4;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 5, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_5 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~mac_compute_ipv4_checksum_U0.dataStreamBuffer0_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~mac_compute_ipv4_checksum_U0.dataStreamBuffer1_blk_n);
    ...
    assign proc_5_data_FIFO_blk[2] = 1'b0 | (~mac_compute_ipv4_checksum_U0.subSumFifo_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 6, 2, 2) mac_ip_encode_top_hls_deadlock_detect_unit_6 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~mac_finalize_ipv4_checksum_32_U0.subSumFifo_blk_n);
    ...
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~mac_finalize_ipv4_checksum_32_U0.checksumFifo_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 7, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_7 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~insert_ip_checksum_512_U0.dataStreamBuffer1_blk_n);
    ...
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~insert_ip_checksum_512_U0.checksumFifo_blk_n);
    ...
    assign proc_7_data_FIFO_blk[2] = 1'b0 | (~insert_ip_checksum_512_U0.dataStreamBuffer2_blk_n);
    ...
    assign in_chan_dep_data_vec_7[21 : 11] = dep_chan_data_6_7;
    assign token_in_vec_7[1] = token_6_7;
    assign in_chan_dep_vld_vec_7[2] = dep_chan_vld_8_7;
    assign in_chan_dep_data_vec_7[32 : 22] = dep_chan_data_8_7;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 8, 4, 4) mac_ip_encode_top_hls_deadlock_detect_unit_8 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_8_data_FIFO_blk[0] = 1'b0 | (~handle_arp_reply_512_U0.myMacAddress_blk_n);
    ...
    assign proc_8_data_FIFO_blk[1] = 1'b0 | (~handle_arp_reply_512_U0.dataStreamBuffer2_blk_n);
    ...
    assign proc_8_data_FIFO_blk[2] = 1'b0 | (~handle_arp_reply_512_U0.headerFifo_blk_n);
    ...
    assign proc_8_data_FIFO_blk[3] = 1'b0 | (~handle_arp_reply_512_U0.dataStreamBuffer3_blk_n);
    ...
    assign in_chan_dep_data_vec_8[10 : 0] = dep_chan_data_1_8;
    ...
    assign in_chan_dep_data_vec_8[43 : 33] = dep_chan_data_10_8;
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 9, 2, 2) mac_ip_encode_top_hls_deadlock_detect_unit_9 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_9_data_FIFO_blk[0] = 1'b0 | (~mac_lshiftWordByOctet_512_1_U0.dataStreamBuffer4_blk_n);
    ...
    assign proc_9_data_FIFO_blk[1] = 1'b0 | (~mac_lshiftWordByOctet_512_1_U0.dataStreamBuffer3_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(11, 10, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_10 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_10_data_FIFO_blk[0] = 1'b0 | (~insert_ethernet_header_512_U0.headerFifo_blk_n);
    ...
    assign proc_10_data_FIFO_blk[1] = 1'b0 | (~insert_ethernet_header_512_U0.dataOut_internal_blk_n);
    ...
    assign proc_10_data_FIFO_blk[2] = 1'b0 | (~insert_ethernet_header_512_U0.dataStreamBuffer4_blk_n);
    ...
    assign in_chan_dep_data_vec_10[10 : 0] = dep_chan_data_3_10;
