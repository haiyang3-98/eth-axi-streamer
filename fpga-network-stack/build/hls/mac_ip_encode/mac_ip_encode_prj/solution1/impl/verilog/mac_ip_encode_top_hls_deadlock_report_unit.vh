    ...
    function [584:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0";
                end
                1 : begin
                    proc_path = "mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0";
                end
                2 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    case(index2)
                    1: begin
                        if (~mac_ip_encode_top_entry3_U0.myMacAddress_out_blk_n) begin
                            if (~myMacAddress_c1_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~myMacAddress_c1_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~mac_ip_encode_top_entry3_U0.regSubNetMask_out_blk_n) begin
                            if (~regSubNetMask_c2_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regSubNetMask_c2_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~mac_ip_encode_top_entry3_U0.regDefaultGateway_out_blk_n) begin
                            if (~regDefaultGateway_c3_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regDefaultGateway_c3_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                1 : begin
                    case(index2)
                    0: begin
                        if (~mac_ip_encode_top_entry12_U0.myMacAddress_blk_n) begin
                            if (~myMacAddress_c1_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~myMacAddress_c1_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~mac_ip_encode_top_entry12_U0.regSubNetMask_blk_n) begin
                            if (~regSubNetMask_c2_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regSubNetMask_c2_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c2_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~mac_ip_encode_top_entry12_U0.regDefaultGateway_blk_n) begin
                            if (~regDefaultGateway_c3_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regDefaultGateway_c3_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c3_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    8: begin
                        if (~mac_ip_encode_top_entry12_U0.myMacAddress_out_blk_n) begin
                    ...
                    4: begin
                        if (~mac_ip_encode_top_entry12_U0.regSubNetMask_out_blk_n) begin
                        ...
                        if (~mac_ip_encode_top_entry12_U0.regDefaultGateway_out_blk_n) begin
                ...
                4 : begin
                    ...
                    1: begin
                        if (~extract_ip_address_512_U0.regSubNetMask_blk_n) begin
                            if (~regSubNetMask_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regSubNetMask_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regSubNetMask_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~extract_ip_address_512_U0.regDefaultGateway_blk_n) begin
                            if (~regDefaultGateway_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regDefaultGateway_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.regDefaultGateway_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                8 : begin
                    ...
                    1: begin
                        if (~handle_arp_reply_512_U0.myMacAddress_blk_n) begin
                            if (~myMacAddress_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c_U' written by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~myMacAddress_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c_U' read by process 'mac_ip_encode_top_mac_ip_encode_top.mac_ip_encode_top_entry12_U0'");
                                $fdisplay(fp, "Dependence_Channel_path mac_ip_encode_top_mac_ip_encode_top.myMacAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
