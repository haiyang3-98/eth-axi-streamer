...
attribute shreg_extract : string;
    ...
    signal ref_tmp_data_i_reg_95 : STD_LOGIC_VECTOR (511 downto 0);
    signal ref_tmp_keep_i_reg_100 : STD_LOGIC_VECTOR (63 downto 0);
    signal ref_tmp_last_i_reg_105 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_32_i_fu_79_p4 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    regslice_both_input_V_data_V_U : component mac_ip_encode_top_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_V_keep_V_U : component mac_ip_encode_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_V_strb_V_U : component mac_ip_encode_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_V_last_V_U : component mac_ip_encode_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ref_tmp_data_i_reg_95 <= s_axis_ip_TDATA_int_regslice;
                ref_tmp_keep_i_reg_100 <= s_axis_ip_TKEEP_int_regslice;
                ref_tmp_last_i_reg_105 <= s_axis_ip_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (dataIn_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_ip_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ap_done_reg, tmp_nbreadreq_fu_34_p6, s_axis_ip_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_ip_TVALID_int_regslice = ap_const_logic_0)));
    end process;
    ...
    dataIn_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_32_i_fu_79_p4),1024));
    ...
    s_axis_ip_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_block_pp0_stage0, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    s_axis_ip_TREADY <= regslice_both_input_V_data_V_U_ack_in;

    s_axis_ip_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_block_pp0_stage0_11001)
    begin
    ...
    tmp_32_i_fu_79_p4 <= ((ref_tmp_last_i_reg_105 & ref_tmp_keep_i_reg_100) & ref_tmp_data_i_reg_95);
    tmp_nbreadreq_fu_34_p6 <= (0=>(s_axis_ip_TVALID_int_regslice), others=>'-');
end behav;
