...
architecture behav of mac_ip_encode_top_mac_lshiftWordByOctet_512_1_s is 
    ...
    constant ap_const_lv400_lc_2 : STD_LOGIC_VECTOR (399 downto 0) := "";
...
attribute shreg_extract : string;
    ...
    signal reg_164 : STD_LOGIC_VECTOR (111 downto 0);
    signal reg_168 : STD_LOGIC_VECTOR (13 downto 0);
    signal trunc_ln674_fu_208_p1 : STD_LOGIC_VECTOR (399 downto 0);
    signal trunc_ln674_reg_362 : STD_LOGIC_VECTOR (399 downto 0);
    signal p_Result_1_i_reg_368 : STD_LOGIC_VECTOR (49 downto 0);
    ...
    signal p_Result_2_i_fu_222_p4 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal select_ln1198_fu_308_p3 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_Result_1_i_reg_368 <= dataStreamBuffer3_dout(561 downto 512);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_load_load_fu_172_p1 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then
                reg_164 <= prevWord_data_V(511 downto 400);
                reg_168 <= prevWord_keep_V(63 downto 50);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_351 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (dataStreamBuffer3_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_351 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (dataStreamBuffer3_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ap_done_reg, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((ls_writeRemainder_load_reg_351 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)));
    end process;
    ...
    currWord_data_V_fu_186_p1 <= dataStreamBuffer3_dout(512 - 1 downto 0);
    currWord_last_V_fu_200_p3 <= dataStreamBuffer3_dout(576 downto 576);

    dataStreamBuffer3_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, ap_block_pp0_stage0)
    begin
    ...
    dataStreamBuffer4_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2, ap_block_pp0_stage0)
    begin
    ...
    dataStreamBuffer4_din_assign_proc : process(ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2, p_s_fu_316_p5, zext_ln174_fu_340_p1, ap_condition_162)
    begin
        if ((ap_const_boolean_1 = ap_condition_162)) then
            if ((ls_writeRemainder_load_reg_351 = ap_const_lv1_1)) then 
                ...
                dataStreamBuffer4_din <= "";
            end if;
        else 
            dataStreamBuffer4_din <= "";
        end if; 
    ...
    dataStreamBuffer4_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_load_reg_351, ap_predicate_op46_write_state2, ap_block_pp0_stage0_11001)
    begin
    ...
    or_ln_fu_328_p5 <= (((ap_const_lv51_4000000000000 & reg_168) & ap_const_lv400_lc_2) & reg_164);
    p_Result_1_fu_279_p3 <= (p_Result_1_i_reg_368 & ap_const_lv14_3FFF);
    p_Result_2_fu_286_p3 <= (trunc_ln674_reg_362 & reg_164);
    p_Result_2_i_fu_222_p4 <= dataStreamBuffer3_dout(575 downto 562);
    p_Result_3_fu_293_p3 <= (p_Result_1_i_reg_368 & reg_168);
    p_Result_s_fu_272_p3 <= (trunc_ln674_reg_362 & ap_const_lv112_0);
    p_s_fu_316_p5 <= (((ap_const_lv447_lc_2 & sendWord_last_V_reg_374) & select_ln1198_fu_308_p3) & sendWord_data_V_2_fu_300_p3);
    select_ln1198_fu_308_p3 <= 
    ...
    sendWord_last_V_fu_232_p2 <= "1" when (p_Result_2_i_fu_222_p4 = ap_const_lv14_0) else "0";
    tmp_i_nbreadreq_fu_86_p3 <= (0=>(dataStreamBuffer3_empty_n), others=>'-');
    trunc_ln674_fu_208_p1 <= dataStreamBuffer3_dout(400 - 1 downto 0);
