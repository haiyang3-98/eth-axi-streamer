...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_ip_TREADY { I 1 bit } m_axis_ip_TVALID { O 1 bit } m_axis_ip_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dataOut_internal_dout { I 1024 vector } dataOut_internal_empty_n { I 1 bit } dataOut_internal_read { O 1 bit } } \
} "
}
