...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_arp_lookup_reply_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_axis_arp_lookup_reply_V_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ s_axis_arp_lookup_reply_V_TDATA sc_in sc_lv 128 signal 0 } 
	{ s_axis_arp_lookup_reply_V_TREADY sc_out sc_logic 1 inacc 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_arp_lookup_reply_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_arp_lookup_reply_V { axis {  { s_axis_arp_lookup_reply_V_TVALID in_vld 0 1 }  { s_axis_arp_lookup_reply_V_TDATA in_data 0 128 }  { s_axis_arp_lookup_reply_V_TREADY in_acc 1 1 } } }
	...
	dataStreamBuffer2 { ap_fifo {  { dataStreamBuffer2_dout fifo_data 0 1024 }  { dataStreamBuffer2_empty_n fifo_status 0 1 }  { dataStreamBuffer2_read fifo_update 1 1 } } }
	headerFifo { ap_fifo {  { headerFifo_din fifo_data 1 256 }  { headerFifo_full_n fifo_status 0 1 }  { headerFifo_write fifo_update 1 1 } } }
	dataStreamBuffer3 { ap_fifo {  { dataStreamBuffer3_din fifo_data 1 1024 }  { dataStreamBuffer3_full_n fifo_status 0 1 }  { dataStreamBuffer3_write fifo_update 1 1 } } }
}
