...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_arp_lookup_request_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axis_arp_lookup_request_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_arp_lookup_request_V_TDATA sc_out sc_lv 32 signal 0 } 
	{ m_axis_arp_lookup_request_V_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_arp_lookup_request_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_arp_lookup_request_V { axis {  { m_axis_arp_lookup_request_V_TREADY out_acc 0 1 }  { m_axis_arp_lookup_request_V_TDATA out_data 1 32 }  { m_axis_arp_lookup_request_V_TVALID out_vld 1 1 } } }
	...
	dataStreamBuffer0 { ap_fifo {  { dataStreamBuffer0_din fifo_data 1 1024 }  { dataStreamBuffer0_full_n fifo_status 0 1 }  { dataStreamBuffer0_write fifo_update 1 1 } } }
}
