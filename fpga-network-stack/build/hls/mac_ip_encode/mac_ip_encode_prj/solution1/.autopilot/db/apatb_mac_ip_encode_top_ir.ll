; ModuleID = '/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/mac_ip_encode/mac_ip_encode_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream.6" = type { %struct.arpTableReply }
%struct.arpTableReply = type { %struct.ap_uint.7, i1 }
%struct.ap_uint.7 = type { %struct.ap_int_base.8 }
%struct.ap_int_base.8 = type { %struct.ssdm_int.9 }
%struct.ssdm_int.9 = type { i48 }
...
%"class.hls::stream.10" = type { %struct.ap_uint.11 }
%struct.ap_uint.11 = type { %struct.ap_int_base.12 }
%struct.ap_int_base.12 = type { %struct.ssdm_int.13 }
%struct.ssdm_int.13 = type { i32 }

; Function Attrs: noinline
define void @apatb_mac_ip_encode_top_ir(%"class.hls::stream"* %dataIn, %"class.hls::stream.6"* %arpTableIn, %"class.hls::stream"* %dataOut, %"class.hls::stream.10"* %arpTableOut, %struct.ap_uint.7* nocapture readonly %myMacAddress, %struct.ap_uint.11* nocapture readonly %regSubNetMask, %struct.ap_uint.11* nocapture readonly %regDefaultGateway) local_unnamed_addr #0 {
entry:
  %dataIn_copy = alloca %"class.hls::stream", align 512
  %arpTableIn_copy = alloca %"class.hls::stream.6", align 512
  %dataOut_copy = alloca %"class.hls::stream", align 512
  %arpTableOut_copy1 = alloca %"class.hls::stream.10", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %dataIn, %"class.hls::stream"* nonnull align 512 %dataIn_copy, %"class.hls::stream.6"* %arpTableIn, %"class.hls::stream.6"* nonnull align 512 %arpTableIn_copy, %"class.hls::stream"* %dataOut, %"class.hls::stream"* nonnull align 512 %dataOut_copy, %"class.hls::stream.10"* %arpTableOut, %"class.hls::stream.10"* nonnull align 512 %arpTableOut_copy1)
  call void @apatb_mac_ip_encode_top_hw(%"class.hls::stream"* %dataIn_copy, %"class.hls::stream.6"* %arpTableIn_copy, %"class.hls::stream"* %dataOut_copy, %"class.hls::stream.10"* %arpTableOut_copy1, %struct.ap_uint.7* %myMacAddress, %struct.ap_uint.11* %regSubNetMask, %struct.ap_uint.11* %regDefaultGateway)
  call fastcc void @copy_out(%"class.hls::stream"* %dataIn, %"class.hls::stream"* nonnull align 512 %dataIn_copy, %"class.hls::stream.6"* %arpTableIn, %"class.hls::stream.6"* nonnull align 512 %arpTableIn_copy, %"class.hls::stream"* %dataOut, %"class.hls::stream"* nonnull align 512 %dataOut_copy, %"class.hls::stream.10"* %arpTableOut, %"class.hls::stream.10"* nonnull align 512 %arpTableOut_copy1)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512) unnamed_addr #1 {
entry:
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  %.01.111.gep13 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 1
  %20 = bitcast i1* %.01.111.gep13 to i8*
  %.0.110.gep14 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 1
...
; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %"class.hls::stream.10", %"class.hls::stream.10"* %1, i32 0, i32 0
  %.01 = getelementptr %"class.hls::stream.10", %"class.hls::stream.10"* %0, i32 0, i32 0
  %9 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %9, label %10, label %11

; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_uint.11(%struct.ap_uint.11* align 512 %.01, %struct.ap_uint.11* %.0)
  br label %ret
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.12(%struct.ap_int_base.12* align 512 %.01.03, %struct.ap_int_base.12* %.0.02)
  br label %ret
...
; <label>:16:                                     ; preds = %14
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.13(%struct.ssdm_int.13* align 512 %.01.0.05, %struct.ssdm_int.13* %.0.0.04)
  br label %ret
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_mac_ip_encode_top_hw(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %struct.ap_uint.7*, %struct.ap_uint.11*, %struct.ap_uint.11*)

define void @mac_ip_encode_top_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %struct.ap_uint.7*, %struct.ap_uint.11*, %struct.ap_uint.11*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %3)
  call void @mac_ip_encode_top_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.6"* %1, %"class.hls::stream"* %2, %"class.hls::stream.10"* %3, %struct.ap_uint.7* %4, %struct.ap_uint.11* %5, %struct.ap_uint.11* %6)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %3)
  ret void
}

declare void @mac_ip_encode_top_hw_stub(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %struct.ap_uint.7*, %struct.ap_uint.11*, %struct.ap_uint.11*)
