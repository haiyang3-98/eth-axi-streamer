...
set C_modelArgList {
	{ dataStreamBuffer1 int 1024 regular {fifo 0 volatile } {global 0}  }
	{ checksumFifo int 16 regular {fifo 0 volatile } {global 0}  }
	{ dataStreamBuffer2 int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dataStreamBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "checksumFifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "dataStreamBuffer2", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ dataStreamBuffer1_dout sc_in sc_lv 1024 signal 0 } 
	...
	{ dataStreamBuffer2_din sc_out sc_lv 1024 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dataStreamBuffer1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "dataStreamBuffer1", "role": "dout" }} , 
 	...
 	{ "name": "dataStreamBuffer2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "dataStreamBuffer2", "role": "din" }} , 
...
set Spec2ImplPortList { 
	dataStreamBuffer1 { ap_fifo {  { dataStreamBuffer1_dout fifo_data 0 1024 }  { dataStreamBuffer1_empty_n fifo_status 0 1 }  { dataStreamBuffer1_read fifo_update 1 1 } } }
	...
	dataStreamBuffer2 { ap_fifo {  { dataStreamBuffer2_din fifo_data 1 1024 }  { dataStreamBuffer2_full_n fifo_status 0 1 }  { dataStreamBuffer2_write fifo_update 1 1 } } }
}
