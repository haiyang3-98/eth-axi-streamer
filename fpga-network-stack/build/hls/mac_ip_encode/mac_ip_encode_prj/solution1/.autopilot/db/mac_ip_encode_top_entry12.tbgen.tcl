set moduleName mac_ip_encode_top_entry12
set isTopModule 0
...
set C_modelName {mac_ip_encode_top.entry12}
...
set C_modelArgList {
	...
	{ regSubNetMask_out int 32 regular {fifo 1}  }
	{ regDefaultGateway_out int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "myMacAddress", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "regSubNetMask_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "regDefaultGateway_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ myMacAddress_out_din sc_out sc_lv 48 signal 3 } 
	{ myMacAddress_out_full_n sc_in sc_logic 1 signal 3 } 
	{ myMacAddress_out_write sc_out sc_logic 1 signal 3 } 
	{ regSubNetMask_out_din sc_out sc_lv 32 signal 4 } 
	{ regSubNetMask_out_full_n sc_in sc_logic 1 signal 4 } 
	{ regSubNetMask_out_write sc_out sc_logic 1 signal 4 } 
	{ regDefaultGateway_out_din sc_out sc_lv 32 signal 5 } 
	{ regDefaultGateway_out_full_n sc_in sc_logic 1 signal 5 } 
	{ regDefaultGateway_out_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "regSubNetMask_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "regSubNetMask_out", "role": "din" }} , 
 	{ "name": "regSubNetMask_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regSubNetMask_out", "role": "full_n" }} , 
 	{ "name": "regSubNetMask_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regSubNetMask_out", "role": "write" }} , 
 	{ "name": "regDefaultGateway_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "regDefaultGateway_out", "role": "din" }} , 
 	{ "name": "regDefaultGateway_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regDefaultGateway_out", "role": "full_n" }} , 
 	{ "name": "regDefaultGateway_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "regDefaultGateway_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "regSubNetMask", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "regSubNetMask_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "regDefaultGateway", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "regDefaultGateway_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "myMacAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "myMacAddress_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "regSubNetMask_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "regSubNetMask_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "regDefaultGateway_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	regSubNetMask_out { ap_fifo {  { regSubNetMask_out_din fifo_data 1 32 }  { regSubNetMask_out_full_n fifo_status 0 1 }  { regSubNetMask_out_write fifo_update 1 1 } } }
	regDefaultGateway_out { ap_fifo {  { regDefaultGateway_out_din fifo_data 1 32 }  { regDefaultGateway_out_full_n fifo_status 0 1 }  { regDefaultGateway_out_write fifo_update 1 1 } } }
}
