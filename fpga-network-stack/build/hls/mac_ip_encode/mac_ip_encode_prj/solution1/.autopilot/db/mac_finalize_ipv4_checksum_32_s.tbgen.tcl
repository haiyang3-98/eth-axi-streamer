set moduleName mac_finalize_ipv4_checksum_32_s
set isTopModule 0
...
set C_modelName {mac_finalize_ipv4_checksum<32>}
set C_modelType { void 0 }
set C_modelArgList {
	{ subSumFifo int 1024 regular {fifo 0 volatile } {global 0}  }
	{ checksumFifo int 16 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "subSumFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "checksumFifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ checksumFifo_din sc_out sc_lv 16 signal 1 } 
	{ checksumFifo_full_n sc_in sc_logic 1 signal 1 } 
	{ checksumFifo_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "checksumFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "checksumFifo", "role": "din" }} , 
 	{ "name": "checksumFifo_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "checksumFifo", "role": "full_n" }} , 
 	{ "name": "checksumFifo_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "checksumFifo", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "checksumFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	checksumFifo { ap_fifo {  { checksumFifo_din fifo_data 1 16 }  { checksumFifo_full_n fifo_status 0 1 }  { checksumFifo_write fifo_update 1 1 } } }
}
