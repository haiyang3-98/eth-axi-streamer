...
set C_modelArgList {
	{ dataStreamBuffer0 int 1024 regular {fifo 0 volatile } {global 0}  }
	{ dataStreamBuffer1 int 1024 regular {fifo 1 volatile } {global 1}  }
	{ subSumFifo int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dataStreamBuffer0", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "dataStreamBuffer1", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dataStreamBuffer0_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "dataStreamBuffer0", "role": "dout" }} , 
 	...
 	{ "name": "dataStreamBuffer1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "dataStreamBuffer1", "role": "din" }} , 
...
set Spec2ImplPortList { 
	dataStreamBuffer0 { ap_fifo {  { dataStreamBuffer0_dout fifo_data 0 1024 }  { dataStreamBuffer0_empty_n fifo_status 0 1 }  { dataStreamBuffer0_read fifo_update 1 1 } } }
	dataStreamBuffer1 { ap_fifo {  { dataStreamBuffer1_din fifo_data 1 1024 }  { dataStreamBuffer1_full_n fifo_status 0 1 }  { dataStreamBuffer1_write fifo_update 1 1 } } }
