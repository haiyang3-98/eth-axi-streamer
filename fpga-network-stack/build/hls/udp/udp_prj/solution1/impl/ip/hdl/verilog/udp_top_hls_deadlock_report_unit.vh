    ...
    function [512:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "udp_top_udp_top.udp_top_entry3_U0";
                end
                1 : begin
                    proc_path = "udp_top_udp_top.udp_top_entry6_U0";
                end
                2 : begin
                    proc_path = "udp_top_udp_top.convert_axis_to_net_axis_512_4_U0";
                end
                3 : begin
                    proc_path = "udp_top_udp_top.convert_axis_to_net_axis_512_U0";
                end
                4 : begin
                    proc_path = "udp_top_udp_top.convert_net_axis_to_axis_512_5_U0";
                end
                5 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    case(index2)
                    1: begin
                        if (~udp_top_entry3_U0.reg_listen_port_out_blk_n) begin
                            if (~reg_listen_port_c1_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.reg_listen_port_c1_U' written by process 'udp_top_udp_top.udp_top_entry6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~reg_listen_port_c1_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.reg_listen_port_c1_U' read by process 'udp_top_udp_top.udp_top_entry6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c1_U");
                ...
                1 : begin
                    case(index2)
                    0: begin
                        if (~udp_top_entry6_U0.reg_listen_port_blk_n) begin
                            if (~reg_listen_port_c1_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.reg_listen_port_c1_U' written by process 'udp_top_udp_top.udp_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~reg_listen_port_c1_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.reg_listen_port_c1_U' read by process 'udp_top_udp_top.udp_top_entry3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c1_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    6: begin
                        if (~udp_top_entry6_U0.reg_listen_port_out_blk_n) begin
                ...
                6 : begin
                    ...
                    1: begin
                        if (~process_udp_512_U0.regListenPort_blk_n) begin
                            if (~reg_listen_port_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.reg_listen_port_c_U' written by process 'udp_top_udp_top.udp_top_entry6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~reg_listen_port_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.reg_listen_port_c_U' read by process 'udp_top_udp_top.udp_top_entry6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.reg_listen_port_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    2: begin
                        if (~process_udp_512_U0.s_axis_rx_data_internal_blk_n) begin
                            if (~s_axis_rx_data_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.s_axis_rx_data_internal_U' written by process 'udp_top_udp_top.convert_axis_to_net_axis_512_4_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.s_axis_rx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~s_axis_rx_data_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.s_axis_rx_data_internal_U' read by process 'udp_top_udp_top.convert_axis_to_net_axis_512_4_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.s_axis_rx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                7 : begin
                    ...
                    4: begin
                        if (~udp_rshiftWordByOctet_net_axis_512_512_2_U0.m_axis_rx_data_internal_blk_n) begin
                            if (~m_axis_rx_data_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.m_axis_rx_data_internal_U' written by process 'udp_top_udp_top.convert_net_axis_to_axis_512_5_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_rx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_rx_data_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.m_axis_rx_data_internal_U' read by process 'udp_top_udp_top.convert_net_axis_to_axis_512_5_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_rx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                10 : begin
                    ...
                    3: begin
                        if (~udp_lshiftWordByOctet_512_1_U0.s_axis_tx_data_internal_blk_n) begin
                            if (~s_axis_tx_data_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.s_axis_tx_data_internal_U' written by process 'udp_top_udp_top.convert_axis_to_net_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.s_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~s_axis_tx_data_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.s_axis_tx_data_internal_U' read by process 'udp_top_udp_top.convert_axis_to_net_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.s_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                11 : begin
                    ...
                    5: begin
                        if (~generate_udp_512_U0.m_axis_tx_data_internal_blk_n) begin
                            if (~m_axis_tx_data_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.m_axis_tx_data_internal_U' written by process 'udp_top_udp_top.convert_net_axis_to_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_tx_data_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.m_axis_tx_data_internal_U' read by process 'udp_top_udp_top.convert_net_axis_to_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
