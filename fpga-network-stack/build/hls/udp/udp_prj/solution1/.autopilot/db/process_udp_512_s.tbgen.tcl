...
set C_modelArgList {
	...
	{ rx_udpMetaFifo int 64 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "regListenPort", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rx_udpMetaFifo", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rx_udpMetaFifo_din sc_out sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rx_udpMetaFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "rx_udpMetaFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	rx_udpMetaFifo { ap_fifo {  { rx_udpMetaFifo_din fifo_data 1 64 }  { rx_udpMetaFifo_full_n fifo_status 0 1 }  { rx_udpMetaFifo_write fifo_update 1 1 } } }
}
