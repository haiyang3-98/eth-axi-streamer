...
set C_modelArgList {
	...
	{ output_V_strb_V int 64 regular {axi_s 1 volatile  { m_axis_tx_data Strb } }  }
	{ output_V_last_V int 1 regular {axi_s 1 volatile  { m_axis_tx_data Last } }  }
	{ m_axis_tx_data_internal int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "m_axis_tx_data_internal", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ m_axis_tx_data_internal_dout sc_in sc_lv 1024 signal 4 } 
	{ m_axis_tx_data_internal_empty_n sc_in sc_logic 1 signal 4 } 
	{ m_axis_tx_data_internal_read sc_out sc_logic 1 signal 4 } 
	...
	{ m_axis_tx_data_TSTRB sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axis_tx_data_internal_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "m_axis_tx_data_internal", "role": "dout" }} , 
 	{ "name": "m_axis_tx_data_internal_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m_axis_tx_data_internal", "role": "empty_n" }} , 
 	{ "name": "m_axis_tx_data_internal_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m_axis_tx_data_internal", "role": "read" }} , 
 	...
 	{ "name": "m_axis_tx_data_TSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_V_strb_V", "role": "STRB" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "m_axis_tx_data_internal", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	output_V_strb_V { axis {  { m_axis_tx_data_TSTRB out_data 1 64 } } }
	...
	m_axis_tx_data_internal { ap_fifo {  { m_axis_tx_data_internal_dout fifo_data 0 1024 }  { m_axis_tx_data_internal_empty_n fifo_status 0 1 }  { m_axis_tx_data_internal_read fifo_update 1 1 } } }
}
