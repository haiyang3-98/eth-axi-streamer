...
set C_modelArgList {
	...
	{ rx_udpMetaFifo int 64 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_rx_meta_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_rx_meta_V", "interface" : "axis", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "rx_udpMetaFifo", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rx_udpMetaFifo_dout sc_in sc_lv 64 signal 2 } 
	{ rx_udpMetaFifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ rx_udpMetaFifo_read sc_out sc_logic 1 signal 2 } 
	{ m_axis_rx_meta_V_TREADY sc_in sc_logic 1 outacc 1 } 
	{ s_axis_rx_meta_V_TDATA sc_in sc_lv 64 signal 0 } 
	{ s_axis_rx_meta_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ m_axis_rx_meta_V_TDATA sc_out sc_lv 256 signal 1 } 
	{ m_axis_rx_meta_V_TVALID sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rx_udpMetaFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "rx_udpMetaFifo", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_meta_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_rx_meta_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_rx_meta_V { axis {  { s_axis_rx_meta_V_TVALID in_vld 0 1 }  { s_axis_rx_meta_V_TDATA in_data 0 64 }  { s_axis_rx_meta_V_TREADY in_acc 1 1 } } }
	m_axis_rx_meta_V { axis {  { m_axis_rx_meta_V_TREADY out_acc 0 1 }  { m_axis_rx_meta_V_TDATA out_data 1 256 }  { m_axis_rx_meta_V_TVALID out_vld 1 1 } } }
	rx_udpMetaFifo { ap_fifo {  { rx_udpMetaFifo_dout fifo_data 0 64 }  { rx_udpMetaFifo_empty_n fifo_status 0 1 }  { rx_udpMetaFifo_read fifo_update 1 1 } } }
}
