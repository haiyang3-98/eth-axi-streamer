...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_tx_meta_V", "interface" : "axis", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_tx_meta_V", "interface" : "axis", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axis_tx_meta_V_TREADY sc_in sc_logic 1 outacc 1 } 
	...
	{ s_axis_tx_meta_V_TDATA sc_in sc_lv 256 signal 0 } 
	{ s_axis_tx_meta_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ m_axis_tx_meta_V_TDATA sc_out sc_lv 64 signal 1 } 
	{ m_axis_tx_meta_V_TVALID sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_tx_meta_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tx_meta_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_tx_meta_V { axis {  { s_axis_tx_meta_V_TVALID in_vld 0 1 }  { s_axis_tx_meta_V_TDATA in_data 0 256 }  { s_axis_tx_meta_V_TREADY in_acc 1 1 } } }
	m_axis_tx_meta_V { axis {  { m_axis_tx_meta_V_TREADY out_acc 0 1 }  { m_axis_tx_meta_V_TDATA out_data 1 64 }  { m_axis_tx_meta_V_TVALID out_vld 1 1 } } }
