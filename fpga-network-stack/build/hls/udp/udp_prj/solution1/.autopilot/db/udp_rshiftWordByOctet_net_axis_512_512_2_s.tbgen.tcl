set moduleName udp_rshiftWordByOctet_net_axis_512_512_2_s
set isTopModule 0
...
set C_modelName {udp_rshiftWordByOctet<net_axis<512>, 512, 2>}
set C_modelType { void 0 }
set C_modelArgList {
	{ rx_udp2shiftFifo int 1024 regular {fifo 0 volatile } {global 0}  }
	{ m_axis_rx_data_internal int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rx_udp2shiftFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ rx_udp2shiftFifo_dout sc_in sc_lv 1024 signal 0 } 
	{ rx_udp2shiftFifo_empty_n sc_in sc_logic 1 signal 0 } 
	{ rx_udp2shiftFifo_read sc_out sc_logic 1 signal 0 } 
	{ m_axis_rx_data_internal_din sc_out sc_lv 1024 signal 1 } 
	{ m_axis_rx_data_internal_full_n sc_in sc_logic 1 signal 1 } 
	{ m_axis_rx_data_internal_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rx_udp2shiftFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rx_udp2shiftFifo", "role": "dout" }} , 
 	{ "name": "rx_udp2shiftFifo_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rx_udp2shiftFifo", "role": "empty_n" }} , 
 	{ "name": "rx_udp2shiftFifo_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rx_udp2shiftFifo", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "rx_udp2shiftFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	rx_udp2shiftFifo { ap_fifo {  { rx_udp2shiftFifo_dout fifo_data 0 1024 }  { rx_udp2shiftFifo_empty_n fifo_status 0 1 }  { rx_udp2shiftFifo_read fifo_update 1 1 } } }
