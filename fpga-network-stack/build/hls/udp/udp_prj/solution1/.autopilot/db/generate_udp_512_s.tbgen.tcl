...
set C_modelArgList {
	...
	{ tx_shift2udpFifo int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tx_udpMetaFifo", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "tx_shift2udpFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ tx_shift2udpFifo_dout sc_in sc_lv 1024 signal 2 } 
	...
	{ m_axis_tx_data_internal_din sc_out sc_lv 1024 signal 1 } 
	{ m_axis_tx_data_internal_full_n sc_in sc_logic 1 signal 1 } 
	{ m_axis_tx_data_internal_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tx_shift2udpFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "tx_shift2udpFifo", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	tx_udpMetaFifo { ap_fifo {  { tx_udpMetaFifo_dout fifo_data 0 64 }  { tx_udpMetaFifo_empty_n fifo_status 0 1 }  { tx_udpMetaFifo_read fifo_update 1 1 } } }
	...
	tx_shift2udpFifo { ap_fifo {  { tx_shift2udpFifo_dout fifo_data 0 1024 }  { tx_shift2udpFifo_empty_n fifo_status 0 1 }  { tx_shift2udpFifo_read fifo_update 1 1 } } }
}
