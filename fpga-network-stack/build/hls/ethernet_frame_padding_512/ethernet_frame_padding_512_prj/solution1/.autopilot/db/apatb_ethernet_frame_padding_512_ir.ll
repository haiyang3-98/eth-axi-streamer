; ModuleID = '/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/ethernet_frame_padding_512/ethernet_frame_padding_512_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_ethernet_frame_padding_512_ir(%"class.hls::stream"* %dataIn, %"class.hls::stream"* %dataOut) local_unnamed_addr #0 {
entry:
  %dataIn_copy = alloca %"class.hls::stream", align 512
  %dataOut_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %dataIn, %"class.hls::stream"* nonnull align 512 %dataIn_copy, %"class.hls::stream"* %dataOut, %"class.hls::stream"* nonnull align 512 %dataOut_copy)
  call void @apatb_ethernet_frame_padding_512_hw(%"class.hls::stream"* %dataIn_copy, %"class.hls::stream"* %dataOut_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %dataIn, %"class.hls::stream"* nonnull align 512 %dataIn_copy, %"class.hls::stream"* %dataOut, %"class.hls::stream"* nonnull align 512 %dataOut_copy)
  ret void
}
...
declare void @apatb_ethernet_frame_padding_512_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @ethernet_frame_padding_512_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @ethernet_frame_padding_512_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @ethernet_frame_padding_512_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
