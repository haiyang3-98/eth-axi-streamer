...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_TVALID { O 1 bit } m_axis_TREADY { I 1 bit } m_axis_TLAST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 9
set RegSliceName ethernet_frame_padding_512_regslice_both
set RegSliceInstName ethernet_frame_padding_512_regslice_both_U
set CoreName ap_simcore_ethernet_frame_padding_512_regslice_both
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix ethernet_frame_padding_512_ \
    sliceTypeList 0\
}"
} else {
