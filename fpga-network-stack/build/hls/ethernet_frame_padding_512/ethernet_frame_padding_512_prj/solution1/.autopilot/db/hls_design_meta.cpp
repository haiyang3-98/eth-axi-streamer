...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("m_axis_TDATA", 512, hls_out, 4, "axis", "out_data", 1),
	Port_Property("m_axis_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("m_axis_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("m_axis_TKEEP", 64, hls_out, 5, "axis", "out_data", 1),
	Port_Property("m_axis_TSTRB", 64, hls_out, 6, "axis", "out_data", 1),
	Port_Property("m_axis_TLAST", 1, hls_out, 7, "axis", "out_data", 1),
};
const char* HLS_Design_Meta::dut_name = "ethernet_frame_padding_512";
