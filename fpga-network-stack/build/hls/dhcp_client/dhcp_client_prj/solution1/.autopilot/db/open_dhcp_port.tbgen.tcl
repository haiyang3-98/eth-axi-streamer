...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_open_port_V", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s_axis_open_port_status_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_open_port_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_open_port_status_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_open_port_V { axis {  { m_axis_open_port_V_TREADY out_acc 0 1 }  { m_axis_open_port_V_TDATA out_data 1 16 }  { m_axis_open_port_V_TVALID out_vld 1 1 } } }
	s_axis_open_port_status_V { axis {  { s_axis_open_port_status_V_TVALID in_vld 0 1 }  { s_axis_open_port_status_V_TDATA in_data 0 8 }  { s_axis_open_port_status_V_TREADY in_acc 1 1 } } }
