...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_tx_metadata_V", "interface" : "axis", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m_axis_tx_length_V", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ dhcp_requestMetaFifo_dout sc_in sc_lv 96 signal 7 } 
	...
	{ m_axis_tx_length_V_TREADY sc_in sc_logic 1 outacc 1 } 
	{ m_axis_tx_metadata_V_TDATA sc_out sc_lv 128 signal 0 } 
	{ m_axis_tx_metadata_V_TVALID sc_out sc_logic 1 outvld 0 } 
	{ m_axis_tx_length_V_TDATA sc_out sc_lv 16 signal 1 } 
	{ m_axis_tx_length_V_TVALID sc_out sc_logic 1 outvld 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tx_length_V_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	m_axis_tx_metadata_V { axis {  { m_axis_tx_metadata_V_TREADY out_acc 0 1 }  { m_axis_tx_metadata_V_TDATA out_data 1 128 }  { m_axis_tx_metadata_V_TVALID out_vld 1 1 } } }
	m_axis_tx_length_V { axis {  { m_axis_tx_length_V_TREADY out_acc 0 1 }  { m_axis_tx_length_V_TDATA out_data 1 16 }  { m_axis_tx_length_V_TVALID out_vld 1 1 } } }
	...
	dhcp_requestMetaFifo { ap_fifo {  { dhcp_requestMetaFifo_dout fifo_data 0 96 }  { dhcp_requestMetaFifo_empty_n fifo_status 0 1 }  { dhcp_requestMetaFifo_read fifo_update 1 1 } } }
}
