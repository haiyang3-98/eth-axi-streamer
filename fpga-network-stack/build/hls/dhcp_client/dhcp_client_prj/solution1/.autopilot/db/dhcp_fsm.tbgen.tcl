...
set Spec2ImplPortList { 
	...
	dhcp_requestMetaFifo { ap_fifo {  { dhcp_requestMetaFifo_din fifo_data 1 96 }  { dhcp_requestMetaFifo_full_n fifo_status 0 1 }  { dhcp_requestMetaFifo_write fifo_update 1 1 } } }
	dhcp_replyMetaFifo { ap_fifo {  { dhcp_replyMetaFifo_dout fifo_data 0 128 }  { dhcp_replyMetaFifo_empty_n fifo_status 0 1 }  { dhcp_replyMetaFifo_read fifo_update 1 1 } } }
}
