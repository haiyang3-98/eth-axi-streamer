set moduleName dhcp_client_entry3
set isTopModule 0
...
set C_modelName {dhcp_client.entry3}
...
set portList { 
	...
	{ inputIpAddress sc_in sc_lv 32 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "dhcpEnable_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "dhcpEnable_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inputIpAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
