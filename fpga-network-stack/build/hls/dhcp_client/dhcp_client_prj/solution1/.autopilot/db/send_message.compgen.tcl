...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_metadata_V_TREADY { I 1 bit } m_axis_tx_metadata_V_TDATA { O 128 vector } m_axis_tx_metadata_V_TVALID { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 38 \
    name m_axis_tx_length_V \
    reset_level 1 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { m_axis_tx_length_V_TREADY { I 1 bit } m_axis_tx_length_V_TDATA { O 16 vector } m_axis_tx_length_V_TVALID { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'm_axis_tx_length_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_data_TSTRB { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_requestMetaFifo_dout { I 96 vector } dhcp_requestMetaFifo_empty_n { I 1 bit } dhcp_requestMetaFifo_read { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 45
set RegSliceName dhcp_client_regslice_both
set RegSliceInstName dhcp_client_regslice_both_U
set CoreName ap_simcore_dhcp_client_regslice_both
