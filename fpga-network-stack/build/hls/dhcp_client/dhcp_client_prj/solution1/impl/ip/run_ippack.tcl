...
set Version     "1.05"
set DisplayName "DHCP Client"
set Revision    "2112599218"
set Description "DHCP Client to be used with the Xilinx Labs TCP & UDP offload engines."
...
set xo_kernel_name "dhcp_client"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/dhcp_client/dhcp_client_prj/solution1"
set debug_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/dhcp_client/dhcp_client_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {dhcp_client_regslice_both
...
dhcp_client_fifo_w32_d2_S
dhcp_client_fifo_w48_d2_S
dhcp_client_fifo_w1_d3_S
dhcp_client_fifo_w32_d3_S
dhcp_client_fifo_w48_d2_S
dhcp_client_fifo_w48_d4_S
dhcp_client_fifo_w1_d2_S
dhcp_client_fifo_w128_d4_S
dhcp_client_fifo_w96_d4_S
dhcp_client_entry3
dhcp_client_entry7
open_dhcp_port
receive_message
...
set Interfaces {
    m_axis_open_port_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_port_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_open_port_status_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_open_port_status_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    m_axis_tx_length_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_length_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    ap_clk {
        ...
        buses "m_axis_open_port_V s_axis_open_port_status_V s_axis_rx_metadata_V s_axis_rx_data m_axis_tx_metadata_V m_axis_tx_length_V m_axis_tx_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 9 II x}
