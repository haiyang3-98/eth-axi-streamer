    ...
    // Process: dhcp_client_entry3_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 0, 1, 1) dhcp_client_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~dhcp_client_entry3_U0.dhcpEnable_out_blk_n) | (~dhcp_client_entry3_U0.inputIpAddress_out_blk_n) | (~dhcp_client_entry3_U0.myMacAddress_out_blk_n);
    ...
    // Process: dhcp_client_entry7_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 1, 4, 4) dhcp_client_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~dhcp_client_entry7_U0.dhcpEnable_blk_n) | (~dhcp_client_entry7_U0.inputIpAddress_blk_n) | (~dhcp_client_entry7_U0.myMacAddress_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~dhcp_client_entry7_U0.dhcpEnable_out_blk_n) | (~dhcp_client_entry7_U0.inputIpAddress_out_blk_n);
    ...
    assign proc_1_data_FIFO_blk[2] = 1'b0 | (~dhcp_client_entry7_U0.myMacAddress_out_blk_n);
    ...
    assign proc_1_data_FIFO_blk[3] = 1'b0 | (~dhcp_client_entry7_U0.myMacAddress_out1_blk_n);
    ...
    // Process: open_dhcp_port_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 2, 1, 1) dhcp_client_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~open_dhcp_port_U0.portOpen_blk_n);
    ...
    // Process: receive_message_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 3, 2, 2) dhcp_client_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~receive_message_U0.myMacAddress_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~receive_message_U0.dhcp_replyMetaFifo_blk_n);
    ...
    // Process: dhcp_fsm_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 4, 4, 4) dhcp_client_hls_deadlock_detect_unit_4 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~dhcp_fsm_U0.dhcpEnable_blk_n) | (~dhcp_fsm_U0.inputIpAddress_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~dhcp_fsm_U0.portOpen_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~dhcp_fsm_U0.dhcp_requestMetaFifo_blk_n);
    ...
    assign proc_4_data_FIFO_blk[3] = 1'b0 | (~dhcp_fsm_U0.dhcp_replyMetaFifo_blk_n);
    ...
    // Process: send_message_U0
    dhcp_client_hls_deadlock_detect_unit #(6, 5, 2, 2) dhcp_client_hls_deadlock_detect_unit_5 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~send_message_U0.myMacAddress_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~send_message_U0.dhcp_requestMetaFifo_blk_n);
...
`include "dhcp_client_hls_deadlock_report_unit.vh"
