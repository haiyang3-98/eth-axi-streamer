...
set Library     "hls"
set IPName      "echo_server_application"
set Version     "1.2"
set DisplayName "Echo Server Application for 10G TOE"
set Revision    "2112600226"
set Description "Echos packets on connections coming in on port 7."
...
set xo_kernel_name "echo_server_application"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/echo_server_application/echo_server_application_prj/solution1"
set debug_dir "/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/echo_server_application/echo_server_application_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {echo_server_application_regslice_both
...
echo_server_application_regslice_both
echo_server_application_regslice_both
echo_server_application_fifo_w16_d64_S
echo_server_application_fifo_w16_d64_S
echo_server_application_fifo_w1024_d2048_A
client
server
open_port
...
## Variables
set Top "echo_server_application"
set TopNoPrefix "echo_server_application"
...
set Interfaces {
    m_axis_listen_port_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_listen_port_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_listen_port_status_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_listen_port_status_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    s_axis_notifications_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_notifications_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_read_package_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_read_package_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_rx_metadata_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_metadata_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_open_connection_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_connection_V"
        has_tready "1"
        ports {
            TDATA 64
        }
    ...
    s_axis_open_status_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_open_status_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_close_connection_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_close_connection_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_tx_metadata_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_metadata_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_tx_status_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tx_status_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    ap_clk {
        ...
        buses "m_axis_listen_port_V s_axis_listen_port_status_V s_axis_notifications_V m_axis_read_package_V s_axis_rx_metadata_V s_axis_rx_data_V m_axis_open_connection_V s_axis_open_status_V m_axis_close_connection_V m_axis_tx_metadata_V m_axis_tx_data_V s_axis_tx_status_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 6.4 machine 64 combinational 0 latency 2 II x}
