...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_open_connection_V", "interface" : "axis", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s_axis_open_status_V", "interface" : "axis", "bitwidth" : 96, "direction" : "READONLY"} , 
 	{ "Name" : "m_axis_close_connection_V", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s_axis_tx_status_V", "interface" : "axis", "bitwidth" : 96, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ s_axis_open_status_V_TVALID sc_in sc_logic 1 invld 1 } 
	{ s_axis_tx_status_V_TVALID sc_in sc_logic 1 invld 3 } 
	{ m_axis_open_connection_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_close_connection_V_TREADY sc_in sc_logic 1 outacc 2 } 
	{ m_axis_open_connection_V_TDATA sc_out sc_lv 64 signal 0 } 
	{ m_axis_open_connection_V_TVALID sc_out sc_logic 1 outvld 0 } 
	{ s_axis_open_status_V_TDATA sc_in sc_lv 96 signal 1 } 
	{ s_axis_open_status_V_TREADY sc_out sc_logic 1 inacc 1 } 
	{ m_axis_close_connection_V_TDATA sc_out sc_lv 16 signal 2 } 
	{ m_axis_close_connection_V_TVALID sc_out sc_logic 1 outvld 2 } 
	{ s_axis_tx_status_V_TDATA sc_in sc_lv 96 signal 3 } 
	{ s_axis_tx_status_V_TREADY sc_out sc_logic 1 inacc 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_open_connection_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_open_status_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_close_connection_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_tx_status_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_open_connection_V { axis {  { m_axis_open_connection_V_TREADY out_acc 0 1 }  { m_axis_open_connection_V_TDATA out_data 1 64 }  { m_axis_open_connection_V_TVALID out_vld 1 1 } } }
	s_axis_open_status_V { axis {  { s_axis_open_status_V_TVALID in_vld 0 1 }  { s_axis_open_status_V_TDATA in_data 0 96 }  { s_axis_open_status_V_TREADY in_acc 1 1 } } }
	m_axis_close_connection_V { axis {  { m_axis_close_connection_V_TREADY out_acc 0 1 }  { m_axis_close_connection_V_TDATA out_data 1 16 }  { m_axis_close_connection_V_TVALID out_vld 1 1 } } }
	s_axis_tx_status_V { axis {  { s_axis_tx_status_V_TVALID in_vld 0 1 }  { s_axis_tx_status_V_TDATA in_data 0 96 }  { s_axis_tx_status_V_TREADY in_acc 1 1 } } }
}
set moduleName dummy
set isTopModule 0
set isCombinational 0
