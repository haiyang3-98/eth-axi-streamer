...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ipDataCheckFifo_dout { I 1024 vector } ipDataCheckFifo_empty_n { I 1 bit } ipDataCheckFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ipDataDropFifo_din { O 1024 vector } ipDataDropFifo_full_n { I 1 bit } ipDataDropFifo_write { O 1 bit } } \
} "
}
