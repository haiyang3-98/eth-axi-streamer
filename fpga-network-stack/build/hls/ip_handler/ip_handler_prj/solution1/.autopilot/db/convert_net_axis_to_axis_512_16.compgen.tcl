...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_icmp_TREADY { I 1 bit } m_axis_icmp_TVALID { O 1 bit } m_axis_icmp_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { m_axis_icmp_internal_dout { I 1024 vector } m_axis_icmp_internal_empty_n { I 1 bit } m_axis_icmp_internal_read { O 1 bit } } \
} "
}
