...
set Spec2ImplPortList { 
	...
	ipDataCheckFifo { ap_fifo {  { ipDataCheckFifo_dout fifo_data 0 1024 }  { ipDataCheckFifo_empty_n fifo_status 0 1 }  { ipDataCheckFifo_read fifo_update 1 1 } } }
	ipDataDropFifo { ap_fifo {  { ipDataDropFifo_din fifo_data 1 1024 }  { ipDataDropFifo_full_n fifo_status 0 1 }  { ipDataDropFifo_write fifo_update 1 1 } } }
}
