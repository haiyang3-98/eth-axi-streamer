...
set C_modelArgList {
	...
	{ ipDataCheckFifo int 1024 regular {fifo 1 volatile } {global 1}  }
	{ iph_subSumsFifoOut int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ipDataMetaFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "ipDataCheckFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "iph_subSumsFifoOut", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ipDataCheckFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "ipDataCheckFifo", "role": "din" }} , 
 	...
 	{ "name": "iph_subSumsFifoOut_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "iph_subSumsFifoOut", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	ipDataCheckFifo { ap_fifo {  { ipDataCheckFifo_din fifo_data 1 1024 }  { ipDataCheckFifo_full_n fifo_status 0 1 }  { ipDataCheckFifo_write fifo_update 1 1 } } }
	iph_subSumsFifoOut { ap_fifo {  { iph_subSumsFifoOut_din fifo_data 1 1024 }  { iph_subSumsFifoOut_full_n fifo_status 0 1 }  { iph_subSumsFifoOut_write fifo_update 1 1 } } }
}
