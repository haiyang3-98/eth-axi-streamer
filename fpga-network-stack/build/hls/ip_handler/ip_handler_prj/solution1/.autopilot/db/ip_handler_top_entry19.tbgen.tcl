set moduleName ip_handler_top_entry19
set isTopModule 0
...
set C_modelName {ip_handler_top.entry19}
...
set portList { 
	...
	{ myIpAddress_out_din sc_out sc_lv 32 signal 1 } 
	{ myIpAddress_out_full_n sc_in sc_logic 1 signal 1 } 
	{ myIpAddress_out_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "myIpAddress_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
