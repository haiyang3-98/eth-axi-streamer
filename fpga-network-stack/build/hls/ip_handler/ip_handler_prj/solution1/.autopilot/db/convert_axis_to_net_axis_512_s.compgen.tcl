...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_raw_TVALID { I 1 bit } s_axis_raw_TREADY { O 1 bit } s_axis_raw_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 9 \
    name s_axis_raw_internal \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_s_axis_raw_internal \
    op interface \
    ports { s_axis_raw_internal_din { O 1024 vector } s_axis_raw_internal_full_n { I 1 bit } s_axis_raw_internal_write { O 1 bit } } \
} "
}
