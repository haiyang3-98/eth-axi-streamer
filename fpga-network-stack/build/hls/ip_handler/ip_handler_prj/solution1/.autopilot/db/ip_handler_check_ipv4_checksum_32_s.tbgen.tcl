...
set C_modelArgList {
	{ iph_subSumsFifoOut int 1024 regular {fifo 0 volatile } {global 0}  }
	{ validChecksumFifo int 1 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "iph_subSumsFifoOut", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ iph_subSumsFifoOut_dout sc_in sc_lv 1024 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iph_subSumsFifoOut_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "iph_subSumsFifoOut", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	iph_subSumsFifoOut { ap_fifo {  { iph_subSumsFifoOut_dout fifo_data 0 1024 }  { iph_subSumsFifoOut_empty_n fifo_status 0 1 }  { iph_subSumsFifoOut_read fifo_update 1 1 } } }
