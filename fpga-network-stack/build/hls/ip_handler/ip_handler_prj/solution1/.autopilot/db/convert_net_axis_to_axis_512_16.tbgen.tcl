set moduleName convert_net_axis_to_axis_512_16
set isTopModule 0
...
set C_modelName {convert_net_axis_to_axis<512>16}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_V_data_V int 512 regular {axi_s 1 volatile  { m_axis_icmp Data } }  }
	{ output_V_keep_V int 64 regular {axi_s 1 volatile  { m_axis_icmp Keep } }  }
	{ output_V_strb_V int 64 regular {axi_s 1 volatile  { m_axis_icmp Strb } }  }
	{ output_V_last_V int 1 regular {axi_s 1 volatile  { m_axis_icmp Last } }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axis_icmp_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "output_V_last_V", "role": "DY" }} , 
 	{ "name": "m_axis_icmp_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "output_V_data_V", "role": "A" }} , 
 	{ "name": "m_axis_icmp_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "output_V_last_V", "role": "ID" }} , 
 	{ "name": "m_axis_icmp_TKEEP", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_V_keep_V", "role": "P" }} , 
 	{ "name": "m_axis_icmp_TSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_V_strb_V", "role": "B" }} , 
 	{ "name": "m_axis_icmp_TLAST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "output_V_last_V", "role": "T" }}  ]}
...
set Spec2ImplPortList { 
	output_V_data_V { axis {  { m_axis_icmp_TDATA out_data 1 512 } } }
	output_V_keep_V { axis {  { m_axis_icmp_TKEEP out_data 1 64 } } }
	output_V_strb_V { axis {  { m_axis_icmp_TSTRB out_data 1 64 } } }
	output_V_last_V { axis {  { m_axis_icmp_TREADY out_acc 0 1 }  { m_axis_icmp_TVALID out_vld 1 1 }  { m_axis_icmp_TLAST out_data 1 1 } } }
