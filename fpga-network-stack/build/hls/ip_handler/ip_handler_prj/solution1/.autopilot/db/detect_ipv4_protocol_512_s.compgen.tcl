...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ipDataCutFifo_dout { I 1024 vector } ipDataCutFifo_empty_n { I 1 bit } ipDataCutFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { udpDataFifo_din { O 1024 vector } udpDataFifo_full_n { I 1 bit } udpDataFifo_write { O 1 bit } } \
} "
}
