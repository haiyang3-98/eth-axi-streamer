...
set C_modelArgList {
	...
	{ ipDataCutFifo int 1024 regular {fifo 0 volatile } {global 0}  }
	{ m_axis_icmp_internal int 1024 regular {fifo 1 volatile } {global 1}  }
	{ udpDataFifo int 1024 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ipv4ProtocolFifo", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "ipDataCutFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "m_axis_icmp_internal", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "udpDataFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ ipDataCutFifo_dout sc_in sc_lv 1024 signal 2 } 
	...
	{ udpDataFifo_din sc_out sc_lv 1024 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ipDataCutFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "ipDataCutFifo", "role": "dout" }} , 
 	...
 	{ "name": "udpDataFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "udpDataFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	ipDataCutFifo { ap_fifo {  { ipDataCutFifo_dout fifo_data 0 1024 }  { ipDataCutFifo_empty_n fifo_status 0 1 }  { ipDataCutFifo_read fifo_update 1 1 } } }
	...
	udpDataFifo { ap_fifo {  { udpDataFifo_din fifo_data 1 1024 }  { udpDataFifo_full_n fifo_status 0 1 }  { udpDataFifo_write fifo_update 1 1 } } }
