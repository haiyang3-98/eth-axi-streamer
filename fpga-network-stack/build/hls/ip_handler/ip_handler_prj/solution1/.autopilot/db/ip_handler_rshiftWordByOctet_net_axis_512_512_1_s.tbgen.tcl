...
set C_modelArgList {
	...
	{ ipDataFifo int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ipv4ShiftFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "ipDataFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ ipDataFifo_din sc_out sc_lv 1024 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ipDataFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "ipDataFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	ipDataFifo { ap_fifo {  { ipDataFifo_din fifo_data 1 1024 }  { ipDataFifo_full_n fifo_status 0 1 }  { ipDataFifo_write fifo_update 1 1 } } }
}
