...
module ipv4_top_convert_axis_to_net_axis_512_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        s_axis_rx_data_internal_din,
        s_axis_rx_data_internal_full_n,
        s_axis_rx_data_internal_write,
...
output  [1023:0] s_axis_rx_data_internal_din;
input   s_axis_rx_data_internal_full_n;
output   s_axis_rx_data_internal_write;
...
reg ap_idle;
reg ap_ready;
reg s_axis_rx_data_internal_write;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_91 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        s_axis_rx_data_internal_write = 1'b1;
    end else begin
        s_axis_rx_data_internal_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_91 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_34_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_91 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0));
end
...
assign s_axis_rx_data_TREADY = regslice_both_input_V_data_V_U_ack_in;

assign s_axis_rx_data_internal_din = tmp_s_fu_79_p4;
...
endmodule //ipv4_top_convert_axis_to_net_axis_512_4
