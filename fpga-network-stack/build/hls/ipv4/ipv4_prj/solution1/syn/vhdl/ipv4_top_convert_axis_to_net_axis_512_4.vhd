...
entity ipv4_top_convert_axis_to_net_axis_512_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ipv4_top_convert_axis_to_net_axis_512_4 is 
...
attribute shreg_extract : string;
    ...
    signal s_axis_rx_data_TDATA_int_regslice : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal s_axis_rx_data_TKEEP_int_regslice : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal s_axis_rx_data_TSTRB_int_regslice : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ref_tmp_data_reg_95 <= s_axis_rx_data_TDATA_int_regslice;
                ref_tmp_keep_reg_100 <= s_axis_rx_data_TKEEP_int_regslice;
                ref_tmp_last_reg_105 <= s_axis_rx_data_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ap_done_reg, tmp_nbreadreq_fu_34_p6, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(s_axis_rx_data_internal_full_n, tmp_reg_91)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((tmp_reg_91 = ap_const_lv1_1) and (s_axis_rx_data_internal_full_n = ap_const_logic_0));
    end process;
    ...
    s_axis_rx_data_TDATA_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_block_pp0_stage0, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    s_axis_rx_data_TREADY <= regslice_both_input_V_data_V_U_ack_in;

    s_axis_rx_data_TREADY_int_regslice_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_block_pp0_stage0_11001)
    begin
    ...
    s_axis_rx_data_internal_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, s_axis_rx_data_internal_full_n, tmp_reg_91, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_reg_91 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            s_axis_rx_data_internal_blk_n <= s_axis_rx_data_internal_full_n;
        else 
            s_axis_rx_data_internal_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    s_axis_rx_data_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_79_p4),1024));

    s_axis_rx_data_internal_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_91, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_reg_91 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            s_axis_rx_data_internal_write <= ap_const_logic_1;
        else 
            s_axis_rx_data_internal_write <= ap_const_logic_0;
        end if; 
    end process;

    tmp_nbreadreq_fu_34_p6 <= (0=>(s_axis_rx_data_TVALID_int_regslice), others=>'-');
