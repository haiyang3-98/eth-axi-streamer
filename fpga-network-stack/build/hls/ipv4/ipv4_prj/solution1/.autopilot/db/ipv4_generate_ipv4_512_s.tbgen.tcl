...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_tx_meta_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_axis_tx_meta_V_TDATA sc_in sc_lv 64 signal 0 } 
...
set Spec2ImplPortList { 
	s_axis_tx_meta_V { axis {  { s_axis_tx_meta_V_TVALID in_vld 0 1 }  { s_axis_tx_meta_V_TDATA in_data 0 64 }  { s_axis_tx_meta_V_TREADY in_acc 1 1 } } }
