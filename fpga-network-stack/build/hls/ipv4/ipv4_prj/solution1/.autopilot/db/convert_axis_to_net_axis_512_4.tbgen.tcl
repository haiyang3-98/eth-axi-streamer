set moduleName convert_axis_to_net_axis_512_4
set isTopModule 0
...
set C_modelName {convert_axis_to_net_axis<512>4}
...
set C_modelArgList {
	...
	{ input_V_strb_V int 64 regular {axi_s 0 volatile  { s_axis_rx_data Strb } }  }
	{ input_V_last_V int 1 regular {axi_s 0 volatile  { s_axis_rx_data Last } }  }
	{ s_axis_rx_data_internal int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "s_axis_rx_data_internal", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_axis_rx_data_internal_din sc_out sc_lv 1024 signal 4 } 
	{ s_axis_rx_data_internal_full_n sc_in sc_logic 1 signal 4 } 
	{ s_axis_rx_data_internal_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_axis_rx_data_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "input_V_last_V", "role": "TVALID" }} , 
 	{ "name": "s_axis_rx_data_internal_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_axis_rx_data_internal", "role": "din" }} , 
 	{ "name": "s_axis_rx_data_internal_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_axis_rx_data_internal", "role": "full_n" }} , 
 	{ "name": "s_axis_rx_data_internal_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_axis_rx_data_internal", "role": "write" }} , 
 	...
 	{ "name": "s_axis_rx_data_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_V_strb_V", "role": "TSTRB" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "s_axis_rx_data_internal", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	input_V_data_V { axis {  { s_axis_rx_data_TDATA in_data 0 512 } } }
	input_V_keep_V { axis {  { s_axis_rx_data_TKEEP in_data 0 64 } } }
	input_V_strb_V { axis {  { s_axis_rx_data_TSTRB in_data 0 64 } } }
	input_V_last_V { axis {  { s_axis_rx_data_TVALID in_vld 0 1 }  { s_axis_rx_data_TREADY in_acc 1 1 }  { s_axis_rx_data_TLAST in_data 0 1 } } }
	s_axis_rx_data_internal { ap_fifo {  { s_axis_rx_data_internal_din fifo_data 1 1024 }  { s_axis_rx_data_internal_full_n fifo_status 0 1 }  { s_axis_rx_data_internal_write fifo_update 1 1 } } }
}
