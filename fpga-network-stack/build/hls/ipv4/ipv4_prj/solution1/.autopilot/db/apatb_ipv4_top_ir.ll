; ModuleID = '/home/haiyang3/eth-axi-streamer/fpga-network-stack/build/hls/ipv4/ipv4_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream.6" = type { %struct.ipv4Meta }
%struct.ipv4Meta = type { %struct.ap_uint.7, %struct.ap_uint.10 }
...
define void @apatb_ipv4_top_ir(%"class.hls::stream"* %s_axis_rx_data, %"class.hls::stream.6"* %m_axis_rx_meta, %"class.hls::stream"* %m_axis_rx_data, %"class.hls::stream.6"* %s_axis_tx_meta, %"class.hls::stream"* %s_axis_tx_data, %"class.hls::stream"* %m_axis_tx_data, %struct.ap_uint.7* nocapture readonly %local_ipv4_address, %struct.ap_uint.13* nocapture readonly %protocol) local_unnamed_addr #0 {
entry:
  %s_axis_rx_data_copy = alloca %"class.hls::stream", align 512
  %m_axis_rx_meta_copy = alloca %"class.hls::stream.6", align 512
  %m_axis_rx_data_copy = alloca %"class.hls::stream", align 512
  %s_axis_tx_meta_copy = alloca %"class.hls::stream.6", align 512
  %s_axis_tx_data_copy = alloca %"class.hls::stream", align 512
  %m_axis_tx_data_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %s_axis_rx_data, %"class.hls::stream"* nonnull align 512 %s_axis_rx_data_copy, %"class.hls::stream.6"* %m_axis_rx_meta, %"class.hls::stream.6"* nonnull align 512 %m_axis_rx_meta_copy, %"class.hls::stream"* %m_axis_rx_data, %"class.hls::stream"* nonnull align 512 %m_axis_rx_data_copy, %"class.hls::stream.6"* %s_axis_tx_meta, %"class.hls::stream.6"* nonnull align 512 %s_axis_tx_meta_copy, %"class.hls::stream"* %s_axis_tx_data, %"class.hls::stream"* nonnull align 512 %s_axis_tx_data_copy, %"class.hls::stream"* %m_axis_tx_data, %"class.hls::stream"* nonnull align 512 %m_axis_tx_data_copy)
  call void @apatb_ipv4_top_hw(%"class.hls::stream"* %s_axis_rx_data_copy, %"class.hls::stream.6"* %m_axis_rx_meta_copy, %"class.hls::stream"* %m_axis_rx_data_copy, %"class.hls::stream.6"* %s_axis_tx_meta_copy, %"class.hls::stream"* %s_axis_tx_data_copy, %"class.hls::stream"* %m_axis_tx_data_copy, %struct.ap_uint.7* %local_ipv4_address, %struct.ap_uint.13* %protocol)
  call fastcc void @copy_out(%"class.hls::stream"* %s_axis_rx_data, %"class.hls::stream"* nonnull align 512 %s_axis_rx_data_copy, %"class.hls::stream.6"* %m_axis_rx_meta, %"class.hls::stream.6"* nonnull align 512 %m_axis_rx_meta_copy, %"class.hls::stream"* %m_axis_rx_data, %"class.hls::stream"* nonnull align 512 %m_axis_rx_data_copy, %"class.hls::stream.6"* %s_axis_tx_meta, %"class.hls::stream.6"* nonnull align 512 %s_axis_tx_meta_copy, %"class.hls::stream"* %s_axis_tx_data, %"class.hls::stream"* nonnull align 512 %s_axis_tx_data_copy, %"class.hls::stream"* %m_axis_tx_data, %"class.hls::stream"* nonnull align 512 %m_axis_tx_data_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* align 512 %7, %"class.hls::stream.6"* %6)
...
; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* align 512 %.01.03, %struct.ap_uint.7* %.0.02)
  br label %19
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* align 512 %.01.0.05, %struct.ap_int_base.8* %.0.0.04)
  br label %19
...
; <label>:16:                                     ; preds = %14
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* align 512 %.01.0.0.07, %struct.ssdm_int.9* %.0.0.0.06)
  br label %19
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  ...
  %20 = bitcast %struct.ap_uint.10* %.0.110 to i8*
  %21 = call i1 @fpga_fifo_exist_2(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.111, %struct.ap_uint.10* %.0.110)
  br label %ret
...
; <label>:23:                                     ; preds = %19
  ...
  %24 = bitcast %struct.ap_int_base.11* %.0.1.012 to i8*
  %25 = call i1 @fpga_fifo_exist_2(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.1.013, %struct.ap_int_base.11* %.0.1.012)
  br label %ret
...
; <label>:27:                                     ; preds = %23
  ...
  %28 = bitcast %struct.ssdm_int.12* %.0.1.0.014 to i8*
  %29 = call i1 @fpga_fifo_exist_2(i8* %28)
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.1.0.015, %struct.ssdm_int.12* %.0.1.0.014)
  br label %ret

; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep19 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i16* %.01.1.0.0.017.gep19 to i8*
  %.0.1.0.0.016.gep20 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* noalias nocapture, %struct.ap_uint.10* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* noalias nocapture, %struct.ap_int_base.11* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* noalias nocapture, %struct.ssdm_int.12* noalias nocapture) unnamed_addr #3 {
entry:
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* %6, %"class.hls::stream.6"* align 512 %7)
...
declare void @apatb_ipv4_top_hw(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint.7*, %struct.ap_uint.13*)

define void @ipv4_top_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint.7*, %struct.ap_uint.13*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  call void @ipv4_top_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.6"* %1, %"class.hls::stream"* %2, %"class.hls::stream.6"* %3, %"class.hls::stream"* %4, %"class.hls::stream"* %5, %struct.ap_uint.7* %6, %struct.ap_uint.13* %7)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  ret void
}

declare void @ipv4_top_hw_stub(%"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint.7*, %struct.ap_uint.13*)
