...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_data_TREADY { I 1 bit } m_axis_rx_data_TVALID { O 1 bit } m_axis_rx_data_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 31 \
    name m_axis_rx_data_internal \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_m_axis_rx_data_internal \
    op interface \
    ports { m_axis_rx_data_internal_dout { I 1024 vector } m_axis_rx_data_internal_empty_n { I 1 bit } m_axis_rx_data_internal_read { O 1 bit } } \
} "
}
