...
# FIFO definition:
set ID 61
set FifoName ipv4_top_fifo_w32_d2_S
set InstName local_ipv4_address_c1_U
...
# FIFO definition:
set ID 62
set FifoName ipv4_top_fifo_w8_d2_S
set InstName protocol_c2_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 63
set FifoName ipv4_top_fifo_w32_d4_S
set InstName local_ipv4_address_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 64
set FifoName ipv4_top_fifo_w8_d4_S
set InstName protocol_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 65
set FifoName ipv4_top_fifo_w1024_d2_S
...
# FIFO definition:
set ID 69
set FifoName ipv4_top_fifo_w1024_d8_A
set InstName rx_process2dropFifo_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 70
set FifoName ipv4_top_fifo_w4_d2_S
set InstName rx_process2dropLengthFifo_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 71
set FifoName ipv4_top_fifo_w1024_d8_A
set InstName tx_shift2ipv4Fifo_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_meta_V_TDATA { O 64 vector } m_axis_rx_meta_V_TVALID { O 1 bit } m_axis_rx_meta_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_tx_meta_V_TDATA { I 64 vector } s_axis_tx_meta_V_TVALID { I 1 bit } s_axis_tx_meta_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 90 \
    name local_ipv4_address \
    type other \
    dir I \
    reset_level 0 \
    sync_rst true \
    corename dc_local_ipv4_address \
    op interface \
    ports { local_ipv4_address { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_protocol \
    op interface \
    ports { protocol { I 8 vector } } \
} "
}
